...
namespace UnitTestsCore {
	public class ProcedureCodeT {
		...
		public static bool AddIfNotPresent(string procCode,bool isCanadianLab=false,string abbrDesc="",long procCat=0,ToothPaintingType toothPaintingType=ToothPaintingType.None) {
