...
namespace UnitTestsCore {
	public class ProcedureCodeT {
		...
		public static ProcedureCode CreateProcCode(string procCode,bool isCanadianLab=false,string abbrDesc="") {
			...
			AddIfNotPresent(procCode,isCanadianLab,abbrDesc);
		...
		public static bool AddIfNotPresent(string procCode,bool isCanadianLab=false,string abbrDesc="") {
