...
namespace UnitTestsCore {
	public class MsgToPaySentT {
		...
		public static MsgToPaySent CreateOne(long clinicNum=0,AutoCommStatus status=AutoCommStatus.SendNotAttempted,DateTime dateFailed=default,long patNum=0,string shortGuid="",string message="",CommType commType=CommType.Text,MsgToPaySource source=MsgToPaySource.Manual) {
