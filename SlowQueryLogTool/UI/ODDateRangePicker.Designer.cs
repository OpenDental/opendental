...
namespace SlowQueryLog.UI {
	partial class ODDateRangePicker {
		...
		private void InitializeComponent() {
			...
			this.panelWeek = new Panel();
			this.butWeekPrevious = new Button();
			this.butWeekNext = new Button();
			this.datePickerFrom = new SlowQueryLog.UI.ODDatePicker();
			this.datePickerTo = new SlowQueryLog.UI.ODDatePicker();
			...
			this.datePickerFrom.CalendarLocation = SlowQueryLog.UI.ODDatePicker.CalendarLocationOptions.Below;
			...
			this.datePickerFrom.CalendarOpened += new SlowQueryLog.UI.CalendarOpenedHandler(this.datePickerFrom_CalendarOpened);
			this.datePickerFrom.CalendarClosed += new SlowQueryLog.UI.CalendarClosedHandler(this.datePickerFrom_CalendarClosed);
			this.datePickerFrom.CalendarSelectionChanged += new SlowQueryLog.UI.CalendarSelectionHandler(this.datePickerFrom_CalendarSelectionChanged);
			// 
			// datePickerTo
			// 
			this.datePickerTo.BackColor = System.Drawing.Color.Transparent;
			this.datePickerTo.CalendarLocation = SlowQueryLog.UI.ODDatePicker.CalendarLocationOptions.Below;
			...
			this.datePickerTo.CalendarOpened += new SlowQueryLog.UI.CalendarOpenedHandler(this.datePickerTo_CalendarOpened);
			this.datePickerTo.CalendarClosed += new SlowQueryLog.UI.CalendarClosedHandler(this.datePickerTo_CalendarClosed);
			this.datePickerTo.CalendarSelectionChanged += new SlowQueryLog.UI.CalendarSelectionHandler(this.datePickerTo_CalendarSelectionChanged);
			// 
			// ODDateRangePicker
			// 
