...
namespace SlowQueryLog.UI {
	partial class ODDatePicker {
		...
		private void InitializeComponent() {
			...
			this.textDate = new SlowQueryLog.ValidDate();
			this.SuspendLayout();
			// 
			// calendar
			// 
			...
			this.butDrop.Image = global::SlowQueryLogTool.Properties.Resources.downArrowWinForm;
		...
		private SlowQueryLog.ValidDate textDate;
	}
}
