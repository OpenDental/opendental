namespace OpenDental.User_Controls.SetupWizard {
	partial class UserControlSetupWizSchedule {
		...
		private void InitializeComponent() {
			...
			this.groupMon = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupMon;
		private OpenDental.UI.GroupBoxOD groupTue;
		private OpenDental.UI.GroupBoxOD groupWed;
		private OpenDental.UI.GroupBoxOD groupThu;
		private OpenDental.UI.GroupBoxOD groupFri;
		private OpenDental.UI.GroupBoxOD groupSat;
		private OpenDental.UI.GroupBoxOD groupSun;
	}
}
