...
namespace OpenDental {
	partial class UserControlFamilyInsurance {
		...
		private void InitializeComponent() {
			...
			this.checkEnableZeroWriteoffOnLimitations = new System.Windows.Forms.CheckBox();
			this.checkEnableZeroWriteoffOnAnnualMax = new System.Windows.Forms.CheckBox();
			...
			this.checkEnableZeroWriteoffOnLimitations.Text = "Ins plans zero out write-offs on frequency or aging met";
			this.checkEnableZeroWriteoffOnLimitations.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			...
			this.checkEnableZeroWriteoffOnAnnualMax.Text = "Ins plans zero out write-offs on annual max met";
			this.checkEnableZeroWriteoffOnAnnualMax.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// groupBoxClaims
			// 
    ...
    "ption";
			...
			this.linkLabelZeroOutWriteoffOnAgeOrFreq.LinkArea = new System.Windows.Forms.LinkArea(0, 10);
			...
			this.linkLabelZeroOutWriteoffOnAgeOrFreq.Text = "Unit Tests 118-123";
			...
			this.linkLabelZeroOutWriteoffOnAnnualMax.LinkArea = new System.Windows.Forms.LinkArea(0, 10);
			...
			this.linkLabelZeroOutWriteoffOnAnnualMax.Text = "Unit Tests 115-117";
		...
		private System.Windows.Forms.CheckBox checkEnableZeroWriteoffOnLimitations;
