...
namespace OpenDental {
    ...
    "yments and adjustments.";
			...
			this.label2.Text = "This report only considers insurance payments and \r\nwriteoffs, not patient paymen" +
    "ts and adjustments. \r\nUse the Procedures Overpaid Report to include \r\npatient pa" +
    "yments and adjustments.";
			// 
			// FormRpInsOverpaid
