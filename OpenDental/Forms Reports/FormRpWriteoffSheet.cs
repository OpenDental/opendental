...
///<summary></summary>
	public partial class FormRpWriteoffSheet : FormODBase {
		...
		private void butOK_Click(object sender,System.EventArgs e) {
			...
			if(writeoffType==PPOWriteoffDateCalc.ClaimPayDate) {
				query.AddGroupSummaryField("Write-off (Writeoff Estimate + Write-off Adjustment)","Provider","$write-off",SummaryOperation.Sum,new List<int>(){0},Color.Black,new Font("Tahoma",9,FontStyle.Bold),0,50);
			}
