...
namespace OpenDental.UI {
	public partial class UnmountedBar:Control {
		...
		public UnmountedBar() {
			...
			butRemount.Size=LayoutManager.ScaleSize(new Size(70,20));
			...
			butDelete.Location=new Point(LayoutManager.Scale(71),0);
			butDelete.Size=LayoutManager.ScaleSize(new Size(70,20));
		...
		public event EventHandler<UnmountedObject> Remount;
		...
		private void butDelete_Click(object sender, EventArgs e){
			...
			//SelectedIndex=-1;
			//Invalidate();
			RefreshParent?.Invoke(this,new EventArgs());
		}
		...
		private void ButRemount_Click(object sender, EventArgs e){
			...
			Remount?.Invoke(this,_listUnmountedObjects[SelectedIndex]);
		}
		...
		private void DrawMountOne(Graphics g,int i){
			...
			g.DrawImage(_listUnmountedObjects[i].Bitmap,0,0);
			g.Restore(graphicsStateMount);
		}
