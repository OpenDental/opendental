		...
		public static void Launch(object sender,FormLauncherEventArgs e) {
			...
			switch(e.EnumFormName_){
				...
				case EnumFormName.FormHouseCalls:
					...
					break;
				case EnumFormName.FormImageFloatWindows:
					type=Type.GetType((typeof(FormImageFloatWindows)).FullName);
					break;
				...
				case EnumFormName.FormOryxUserSettings:
					...
					break;
				case EnumFormName.FormPatientSelect:
					type=Type.GetType((typeof(FormPatientSelect)).FullName);
					break;
