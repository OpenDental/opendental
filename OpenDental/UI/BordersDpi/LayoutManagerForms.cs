...
namespace OpenDental{
	...
	public class LayoutManagerForms{
		/*
The LayoutManager will be obsolete someday. It's being superseded by the UIManager. While the comments below mostly apply to LayoutManager, the math is so similar in UIManager that the comments might also apply to UIManager.
...
TextRenderer will measure a string as too large when printing, so use Graphics instead. TextRenderer was added by MS for GDI (not GDI+) measurments, so it's not accurate.
