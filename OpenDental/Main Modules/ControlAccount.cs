...
namespace OpenDental {
	...
	public partial class ControlAccount:UserControl {
		...
		private void FillUnearnedBreakDown(List<PaySplit> listPaySplitsOnAccount) {
			...
			_gridUnearnedBreakdown.ListGridColumns.Add(new GridColumn(Lan.g(this,"Type"),113));
			_gridUnearnedBreakdown.ListGridColumns.Add(new GridColumn(Lan.g(this,"Amount"),80,HorizontalAlignment.Right));
			...
			LayoutManager.MoveSize(_gridUnearnedBreakdown,new Size(_gridUnearnedBreakdown.ListGridColumns.Sum(x => x.ColWidth),
