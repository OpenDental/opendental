...
namespace OpenDental
{
	...
	public partial class ControlImagesJ : UserControl{
		...
		private void butCancel_Click(object sender, EventArgs e){
			//This button is not visible once you start a series.
...
//todo: dpi for floaters?
		...
		///<summary>Sets panelUnmounted visibility based on the docked mount, and whether it has any unmounted items.</summary>
...
//2021-11-01 Todo:
//Update current thumbnail immediately
