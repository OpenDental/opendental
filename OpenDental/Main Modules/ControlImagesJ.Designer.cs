namespace OpenDental
{
    ...
    "les will be ignored.  Imported files will be deleted.";
			...
			// unmountedBar
			// 
			this.unmountedBar.Location = new System.Drawing.Point(250, 438);
			this.unmountedBar.Name = "unmountedBar";
			this.unmountedBar.Size = new System.Drawing.Size(923, 50);
			this.unmountedBar.TabIndex = 37;
			this.unmountedBar.Text = "unmountedBar1";
			this.unmountedBar.EventClose += new System.EventHandler(this.unmountedBar_Close);
			this.unmountedBar.EventRefreshParent += new System.EventHandler(this.unmountedBar_RefreshParent);
			this.unmountedBar.EventRemount += new System.EventHandler<OpenDental.UI.UnmountedObject>(this.unmountedBar_Remount);
			this.unmountedBar.EventRetake += new System.EventHandler(this.unmountedBar_Retake);
			// 
			// imageSelector
			// 
