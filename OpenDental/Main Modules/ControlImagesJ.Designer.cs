namespace OpenDental
{
	partial class ControlImagesJ
	{
		...
		private void InitializeComponent()
		{
			...
			this.butRetake = new OpenDental.UI.Button();
			...
			this.unmountedBar = new OpenDental.UI.UnmountedBar();
			...
			this.panelAcquire.Controls.Add(this.butRetake);
			...
			// butRetake
			// 
			this.butRetake.Location = new System.Drawing.Point(346, 1);
			this.butRetake.Name = "butRetake";
			this.butRetake.Size = new System.Drawing.Size(57, 20);
			this.butRetake.TabIndex = 40;
			this.butRetake.Text = "Retake";
			this.butRetake.Click += new System.EventHandler(this.butRetake_Click);
			// 
			// labelAcquireNotifications
			// 
			this.labelAcquireNotifications.Location = new System.Drawing.Point(550, 2);
			this.labelAcquireNotifications.Name = "labelAcquireNotifications";
			this.labelAcquireNotifications.Size = new System.Drawing.Size(237, 18);
			...
			this.panelAcquireColor.Location = new System.Drawing.Point(517, 1);
    ...
    "les will be ignored.  Imported files will be deleted.";
			...
			// panelDraw
			// 
			this.panelDraw.Controls.Add(this.labelColor);
			this.panelDraw.Controls.Add(this.butColor);
			...
			this.labelColor.Size = new System.Drawing.Size(44, 25);
			this.labelColor.TabIndex = 162;
			this.labelColor.Text = "Color";
			this.labelColor.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// butColor
			// 
			this.butColor.BackColor = System.Drawing.SystemColors.Control;
			this.butColor.FlatStyle = System.Windows.Forms.FlatStyle.Popup;
			this.butColor.ForeColor = System.Drawing.Color.Black;
			this.butColor.Location = new System.Drawing.Point(44, 0);
			this.butColor.Name = "butColor";
			this.butColor.Size = new System.Drawing.Size(25, 25);
			...
			this.toolBarDraw.Location = new System.Drawing.Point(71, 0);
			...
			// unmountedBar
			// 
			this.unmountedBar.Location = new System.Drawing.Point(270, 438);
			this.unmountedBar.Name = "unmountedBar";
			this.unmountedBar.Size = new System.Drawing.Size(705, 50);
			this.unmountedBar.TabIndex = 37;
			this.unmountedBar.Text = "unmountedBar1";
			this.unmountedBar.RefreshParent += new System.EventHandler(this.unmountedBar_RefreshParent);
			this.unmountedBar.Remount += new System.EventHandler<OpenDental.UI.UnmountedObject>(this.unmountedBar_Remount);
			// 
			// imageSelector
			// 
			...
			this.imageSelector.ItemReselected += new System.EventHandler(this.imageSelector_ItemReselected);
			...
			this.toolBarMain.Size = new System.Drawing.Size(1321, 25);
			...
			this.Controls.Add(this.unmountedBar);
		...
		private UI.Button butRetake;
		private UI.UnmountedBar unmountedBar;
	}
}
