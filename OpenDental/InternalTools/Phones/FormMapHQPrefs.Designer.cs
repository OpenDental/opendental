namespace OpenDental{
	partial class FormMapHQPrefs {
		...
		private void InitializeComponent() {
			...
			this.groupRedTriage = new OpenDental.UI.GroupBoxOD();
			this.textRedTime = new OpenDental.ValidNum();
			this.textRedCalls = new OpenDental.ValidNum();
			this.groupVoicemail = new OpenDental.UI.GroupBoxOD();
			...
			this.groupTriage = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupRedTriage;
		private OpenDental.UI.GroupBoxOD groupVoicemail;
		private System.Windows.Forms.Label labelVMTime;
		private System.Windows.Forms.Label labelVMCalls;
		private OpenDental.UI.GroupBoxOD groupTriage;
