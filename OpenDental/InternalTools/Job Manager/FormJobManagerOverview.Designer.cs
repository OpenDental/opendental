namespace OpenDental{
	partial class FormJobManagerOverview {
		...
		private void InitializeComponent() {
			...
			this.groupPrintOptions = new OpenDental.UI.GroupBoxOD();
			...
			this.groupPresetFilters = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupPresetFilters;
		...
		private UI.GroupBoxOD groupPrintOptions;
