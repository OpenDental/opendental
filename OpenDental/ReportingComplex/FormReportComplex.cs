...
namespace OpenDental.ReportingComplex {
	...
	public partial class FormReportComplex : FormODBase {
		...
		public bool IsRetailStore=false;
      ...
      ToolBarMain.Buttons.Add(butWrapText);
		...
		private void OnExport_Click(){
			...
			if(ODBuild.IsThinfinity()) {
				...
				filePath=@"\\opendental.od\serverfiles\Storage\My\KaitlynW\SnackShack_Reports\P&I_Report_"+DateTime.Now.ToString("yyyyMMdd")+".txt";
			}
			else {
