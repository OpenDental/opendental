...
namespace OpenDental {
	public partial class FormSchedule {
		...
		private void InitializeComponent()
		{
			...
			this.groupCopy = new OpenDental.UI.GroupBoxOD();
			...
			this.groupPaste = new OpenDental.UI.GroupBoxOD();
			...
			this.groupBoxWeekFilter = new OpenDental.UI.GroupBoxOD();
			...
			this.checkPracticeNotes.Location = new System.Drawing.Point(6, 89);
		...
		private OpenDental.UI.GroupBoxOD groupBoxWeekFilter;
