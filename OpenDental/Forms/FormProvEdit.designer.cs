...
namespace OpenDental {
	public partial class FormProvEdit {
		...
		private void InitializeComponent(){
			...
			this.comboEhrMu = new OpenDental.UI.ComboBoxOD();
			...
			this.groupAnesthProvType = new OpenDental.UI.GroupBoxOD();
    ...
    "e Anesthetic Record.";
		...
		private OpenDental.UI.ComboBoxOD comboSchoolClass;
		...
		private OpenDental.UI.ComboBoxOD comboEhrMu;
		...
		private OpenDental.UI.GroupBoxOD groupAnesthProvType;
		...
		private OpenDental.UI.GroupBoxOD groupClinicOverrides;
