...
namespace OpenDental {
	public partial class FormReferralSelect {
		...
		private void InitializeComponent() {
			...
			this.checkPreferred = new OpenDental.UI.CheckBox();
			this.checkShowOther = new OpenDental.UI.CheckBox();
			this.checkShowDoctor = new OpenDental.UI.CheckBox();
			this.checkShowPat = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkShowOther;
		private OpenDental.UI.CheckBox checkShowDoctor;
		private OpenDental.UI.CheckBox checkShowPat;
		private OpenDental.UI.CheckBox checkPreferred;
