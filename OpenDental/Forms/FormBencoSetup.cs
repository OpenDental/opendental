...
namespace OpenDental {
	public partial class FormBencoSetup:FormODBase {
		...
		public FormBencoSetup() {
			...
			_listToolButItems=ToolButItems.GetForProgram(_prog.ProgramNum); //Initially only set up for Main Toolbar
		}
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			foreach(ToolBarsAvail toolbar in listToolBars.GetListSelected<ToolBarsAvail>()) {
