...
namespace OpenDental {
	public partial class FormInsBenefits {
		...
		private void InitializeComponent()
		{
			...
			this.groupYear = new OpenDental.UI.GroupBoxOD();
			...
			// comboPano
			// 
			this.comboPano.Items.AddList(new object[] {
            "Every # Years",
            "# Per Benefit Year",
            "Every # Months",
            "# in Last 12 Months"});
			...
			// comboBW
			// 
			this.comboBW.Items.AddList(new object[] {
            "Every # Years",
            "# Per Benefit Year",
            "Every # Months",
            "# in Last 12 Months"});
    ...
    "rt.\n5 lines in 72 vert\n6 lines in 85 vert\n7 lines in 98";
		...
		private OpenDental.UI.GroupBoxOD groupYear;
