namespace OpenDental{
	partial class FormBenefitFrequencies {
		...
		private void InitializeComponent() {
			...
			this.groupDiagnostic = new OpenDental.UI.GroupBox();
			this.comboCancerScreenings = new OpenDental.UI.ComboBox();
			...
			this.groupPreventive = new OpenDental.UI.GroupBox();
			this.comboSealants = new OpenDental.UI.ComboBox();
			this.textSealants = new OpenDental.ValidNum();
			this.label2 = new System.Windows.Forms.Label();
			this.comboFlouride = new OpenDental.UI.ComboBox();
			this.textFlouride = new OpenDental.ValidNum();
			this.label4 = new System.Windows.Forms.Label();
			this.comboProphy = new OpenDental.UI.ComboBox();
			this.label9 = new System.Windows.Forms.Label();
			this.textProphy = new OpenDental.ValidNum();
			this.label10 = new System.Windows.Forms.Label();
			this.groupRestorative = new OpenDental.UI.GroupBox();
			this.comboCrown = new OpenDental.UI.ComboBox();
			this.label14 = new System.Windows.Forms.Label();
			this.textCrown = new OpenDental.ValidNum();
			this.label15 = new System.Windows.Forms.Label();
			this.groupPerio = new OpenDental.UI.GroupBox();
			this.comboPerioMaint = new OpenDental.UI.ComboBox();
			this.textPerioMaint = new OpenDental.ValidNum();
			this.label17 = new System.Windows.Forms.Label();
			this.comboDebridement = new OpenDental.UI.ComboBox();
			this.textDebridement = new OpenDental.ValidNum();
			this.label18 = new System.Windows.Forms.Label();
			this.comboSRP = new OpenDental.UI.ComboBox();
			this.label19 = new System.Windows.Forms.Label();
			this.textSRP = new OpenDental.ValidNum();
			this.label20 = new System.Windows.Forms.Label();
			this.groupProsthodontics = new OpenDental.UI.GroupBox();
			this.comboDentures = new OpenDental.UI.ComboBox();
			this.label24 = new System.Windows.Forms.Label();
			this.textDentures = new OpenDental.ValidNum();
			this.label25 = new System.Windows.Forms.Label();
			this.groupImplants = new OpenDental.UI.GroupBox();
			this.comboImplant = new OpenDental.UI.ComboBox();
		...
		private OpenDental.UI.GroupBox groupDiagnostic;
		private OpenDental.UI.ComboBox comboCancerScreenings;
		...
		private OpenDental.UI.GroupBox groupPreventive;
		private OpenDental.UI.ComboBox comboSealants;
		private ValidNum textSealants;
		private System.Windows.Forms.Label label2;
		private OpenDental.UI.ComboBox comboFlouride;
		private ValidNum textFlouride;
		private System.Windows.Forms.Label label4;
		private OpenDental.UI.ComboBox comboProphy;
		private System.Windows.Forms.Label label9;
		private ValidNum textProphy;
		private System.Windows.Forms.Label label10;
		private OpenDental.UI.GroupBox groupRestorative;
		private OpenDental.UI.ComboBox comboCrown;
		private System.Windows.Forms.Label label14;
		private ValidNum textCrown;
		private System.Windows.Forms.Label label15;
		private OpenDental.UI.GroupBox groupPerio;
		private OpenDental.UI.ComboBox comboPerioMaint;
		private ValidNum textPerioMaint;
		private System.Windows.Forms.Label label17;
		private OpenDental.UI.ComboBox comboDebridement;
		private ValidNum textDebridement;
		private System.Windows.Forms.Label label18;
		private OpenDental.UI.ComboBox comboSRP;
		private System.Windows.Forms.Label label19;
		private ValidNum textSRP;
		private System.Windows.Forms.Label label20;
		private OpenDental.UI.GroupBox groupProsthodontics;
		private OpenDental.UI.ComboBox comboDentures;
		private System.Windows.Forms.Label label24;
		private ValidNum textDentures;
		private System.Windows.Forms.Label label25;
		private OpenDental.UI.GroupBox groupImplants;
		private OpenDental.UI.ComboBox comboImplant;
