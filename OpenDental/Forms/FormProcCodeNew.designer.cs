...
namespace OpenDental {
	public partial class FormProcCodeNew {
		...
		private void InitializeComponent(){
			...
			this.comboPaintType = new OpenDental.UI.ComboBoxOD();
			this.comboTreatArea = new OpenDental.UI.ComboBoxOD();
		...
		private OpenDental.UI.ComboBoxOD comboPaintType;
		private OpenDental.UI.ComboBoxOD comboTreatArea;
