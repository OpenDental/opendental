namespace OpenDental{
	partial class FormImageFloatWindows {
		...
		private void InitializeComponent() {
			...
			this.listBoxWindows = new OpenDental.UI.ListBox();
			this.listBoxActions = new OpenDental.UI.ListBox();
			this.SuspendLayout();
			// 
			// labelActions
			// 
