	...
	public partial class FormLetterMergeEdit : FormODBase {
      ...
      listOther.Items.Add("TPResponsPartyCityStZip");
		...
		private void butNew_Click(object sender, System.EventArgs e) {
			...
			wrdDoc=WrdApp.Documents.Add(ref objectMissing,ref objectMissing,ref objectMissing,
				ref objectMissing);
			wrdDoc.SaveAs(ref objectName,ref objectMissing,ref objectMissing,ref objectMissing,ref objectMissing,
			...
			wrdDoc.Saved=true;
			wrdDoc.Close(ref objectFalse,ref objectMissing,ref objectMissing);
