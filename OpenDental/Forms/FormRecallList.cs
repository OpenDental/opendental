...
namespace OpenDental {
	...
	public partial class FormRecallList:FormODBase {
		...
		private void SendWebSched() {
			...
			if(comboEmailFromRecalls.GetSelected<EmailAddress>()!=null && comboEmailFromRecalls.GetSelected<EmailAddress>().EmailAddressNum!=0) {//me or static email address, email address for 'me' is the first one in _listEmailAddresses
				emailAddressFrom=comboEmailFromRecalls.GetSelected<EmailAddress>();
			}
