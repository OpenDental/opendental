	...
	public partial class FormRecallList:FormODBase {
		...
		private void FillComboEmail() {
			...
			if(emailAddressMe!=null) {
				...
				comboEmailFromRecalls.Items.Add(Lan.g(this,"Me")+" <"+emailAddressMe.EmailUsername+">");//Just below Practice/Clinic
				comboEmailFromReact.Items.Add(Lan.g(this,"Me")+" <"+emailAddressMe.EmailUsername+">");//Just below Practice/Clinic
			}
			comboEmailFromRecalls.Items.AddList(_listEmailAddresses.Select(x => x.EmailUsername).ToList());
			comboEmailFromReact.Items.AddList(_listEmailAddresses.Select(x => x.EmailUsername).ToList());
		}
