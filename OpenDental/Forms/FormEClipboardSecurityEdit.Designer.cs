namespace OpenDental{
	partial class FormEClipboardSecurityEdit {
		/// <summary>
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormEClipboardSecurityEdit));
			this.butOK = new OpenDental.UI.Button();
			this.butCancel = new OpenDental.UI.Button();
			this.labelFrequency = new System.Windows.Forms.Label();
			this.textFrequency = new OpenDental.ValidNum();
			this.label1 = new System.Windows.Forms.Label();
			this.checkSecurityEnabled = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			// 
			this.checkSecurityEnabled.AutoSize = true;
			this.checkSecurityEnabled.Location = new System.Drawing.Point(132, 12);
			...
			this.checkSecurityEnabled.Size = new System.Drawing.Size(136, 17);
			this.checkSecurityEnabled.TabIndex = 10;
			this.checkSecurityEnabled.Text = "Enable Clinical Security";
			this.checkSecurityEnabled.UseVisualStyleBackColor = true;
		...
		private System.Windows.Forms.CheckBox checkSecurityEnabled;
	}
}