namespace OpenDental{
	partial class FormEServicesEClipboard{
		...
		private void InitializeComponent() {
			...
			this.groupEClipboardRules = new OpenDental.UI.GroupBoxOD();
			this.checkEClipboardShowPerioGraphical = new System.Windows.Forms.CheckBox();
			this.checkEClipboardAllowPaymentCheckIn = new System.Windows.Forms.CheckBox();
			this.groupBoxImage = new OpenDental.UI.GroupBoxOD();
			this.butImageOptions = new OpenDental.UI.Button();
			this.textEclipboardImageDefs = new System.Windows.Forms.TextBox();
			this.checkDisplayIndividually = new System.Windows.Forms.CheckBox();
			...
			this.groupEClipboardSheets = new OpenDental.UI.GroupBoxOD();
			...
			// 
			this.groupEClipboardRules.Controls.Add(this.checkEClipboardShowPerioGraphical);
			...
			// 
			// checkEClipboardShowPerioGraphical
			// 
			this.checkEClipboardShowPerioGraphical.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkEClipboardShowPerioGraphical.Location = new System.Drawing.Point(19, 158);
			this.checkEClipboardShowPerioGraphical.Name = "checkEClipboardShowPerioGraphical";
			this.checkEClipboardShowPerioGraphical.Size = new System.Drawing.Size(458, 17);
			this.checkEClipboardShowPerioGraphical.TabIndex = 505;
			this.checkEClipboardShowPerioGraphical.Text = "Show Graphical Perio Chart";
			this.checkEClipboardShowPerioGraphical.UseVisualStyleBackColor = true;
			this.checkEClipboardShowPerioGraphical.Click += new System.EventHandler(this.checkEClipboardShowPerioGraphical_Click);
			// 
			...
			this.checkEClipboardAllowPaymentCheckIn.UseVisualStyleBackColor = true;
			...
			this.groupBoxImage.Location = new System.Drawing.Point(19, 367);
			...
			this.checkDisplayIndividually.UseVisualStyleBackColor = true;
			...
			// 
			this.labelEClipboardMessage.Location = new System.Drawing.Point(16, 274);
			...
			// 
			this.textEClipboardMessage.Location = new System.Drawing.Point(19, 295);
		...
		private OpenDental.UI.GroupBoxOD groupEClipboardSheets;
		...
		private OpenDental.UI.GroupBoxOD groupBoxImage;
		...
		private System.Windows.Forms.CheckBox checkEClipboardShowPerioGraphical;
	}
}