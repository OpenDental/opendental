namespace OpenDental{
	partial class FormBackupReminder {
		...
		private void InitializeComponent() {
			...
			this.checkNoBackups = new OpenDental.UI.CheckBox();
			this.checkBackupMethodOnline = new OpenDental.UI.CheckBox();
			this.labelBackupMethod = new System.Windows.Forms.Label();
			this.checkBackupMethodRemovable = new OpenDental.UI.CheckBox();
			this.checkBackupMethodOther = new OpenDental.UI.CheckBox();
			this.checkBackupMethodNetwork = new OpenDental.UI.CheckBox();
			this.checkRestoreServer = new OpenDental.UI.CheckBox();
			this.checkRestoreHome = new OpenDental.UI.CheckBox();
			this.labelProof = new System.Windows.Forms.Label();
			this.checkNoProof = new OpenDental.UI.CheckBox();
			this.checkNoStrategy = new OpenDental.UI.CheckBox();
			this.checkSecondaryMethodHardCopy = new OpenDental.UI.CheckBox();
			this.checkSecondaryMethodArchive = new OpenDental.UI.CheckBox();
			...
			// 
			this.labelSupplementalBackupDisabled.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
    ...
    "er to store Supplemental Backups locally.";
		...
		private OpenDental.UI.CheckBox checkNoBackups;
		private OpenDental.UI.CheckBox checkBackupMethodOnline;
		private System.Windows.Forms.Label labelBackupMethod;
		private OpenDental.UI.CheckBox checkBackupMethodRemovable;
		private OpenDental.UI.CheckBox checkBackupMethodOther;
		private OpenDental.UI.CheckBox checkBackupMethodNetwork;
		private OpenDental.UI.CheckBox checkRestoreServer;
		private OpenDental.UI.CheckBox checkRestoreHome;
		private System.Windows.Forms.Label labelProof;
		private OpenDental.UI.CheckBox checkNoProof;
		private OpenDental.UI.CheckBox checkNoStrategy;
		private OpenDental.UI.CheckBox checkSecondaryMethodHardCopy;
		private OpenDental.UI.CheckBox checkSecondaryMethodArchive;
