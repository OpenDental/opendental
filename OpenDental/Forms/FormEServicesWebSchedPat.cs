...
namespace OpenDental {
	public partial class FormEServicesWebSchedPat:FormODBase {
		...
		private void FillGridApptOps() {
			...
			gridApptOps.Columns.Add(new GridColumn(Lan.g("TableOperatories","Op Name"),opNameWidth));
			gridApptOps.Columns.Add(new GridColumn(Lan.g("TableOperatories","Abbrev"),60));
			if(PrefC.HasClinicsEnabled) {
				gridApptOps.Columns.Add(new GridColumn(Lan.g("TableOperatories","Clinic"),clinicWidth));
			}
			...
			gridApptOps.Columns.Add(new GridColumn(Lan.g("TableOperatories","ApptTypes"),40) { IsWidthDynamic=true });
		...
		private void FillGridReasons() {
			...
			gridReasons.Columns.Add(new GridColumn(Lan.g(this,"Pattern"),80) { IsWidthDynamic=true });
