namespace OpenDental{
	partial class FormImageDrawColor {
		...
		private void InitializeComponent() {
			...
			this.butOK.Location = new System.Drawing.Point(150, 143);
			...
			this.butCancel.Location = new System.Drawing.Point(242, 143);
			...
			// labelColorFore
			// 
			this.labelColorFore.Location = new System.Drawing.Point(16, 70);
			...
			this.butColorFore.Location = new System.Drawing.Point(153, 69);
			...
			// labelColorTextBack
			// 
			this.labelColorTextBack.Location = new System.Drawing.Point(1, 96);
			...
			this.butColorTextBack.Location = new System.Drawing.Point(153, 95);
			...
			// checkTransparent
			// 
			this.checkTransparent.Location = new System.Drawing.Point(191, 97);
			...
			// labelMount
			// 
			this.labelMount.Location = new System.Drawing.Point(26, 14);
			this.labelMount.Name = "labelMount";
			this.labelMount.Size = new System.Drawing.Size(271, 43);
			this.labelMount.TabIndex = 170;
			this.labelMount.Text = "This just changes the active colors for drawing and text.  If you want to change " +
    "the default mount colors, go to the Mount Info window.";
			// 
			// FormImageDrawColor
			// 
