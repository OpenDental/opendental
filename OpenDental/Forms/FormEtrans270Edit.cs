...
namespace OpenDental {
	public partial class FormEtrans270Edit:FormODBase {
		...
		private void FormEtrans270Edit_Load(object sender,EventArgs e) {
			...
			if((isClaimConnect || isEds) && EtransAck271!=null && EtransAck271.AckEtransNum!=0) {
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			bool isAuthorized=Security.IsAuthorized(Permissions.InsPlanEdit,true);
		...
		private void butPrint_Click(object sender,EventArgs e) {
			...
			if(isClaimConnect && string.IsNullOrEmpty(_htmlResponse)) {
				...
				if(etransHtml!=null && etransHtml.EtransNum > 0) {
					...
					EtransAck271.AckEtrans=etransHtml;
					EtransAck271.AckEtransNum=etransHtml.EtransNum;
					Etranss.Update(EtransAck271);
