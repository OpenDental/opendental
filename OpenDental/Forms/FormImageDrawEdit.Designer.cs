namespace OpenDental{
	partial class FormImageDrawEdit {
		...
		private void InitializeComponent() {
			...
			this.groupBoxFont = new OpenDental.UI.GroupBox();
			...
			// groupBoxFont
			// 
			this.groupBoxFont.Controls.Add(this.butCalculateApparent);
			this.groupBoxFont.Controls.Add(this.textFontSize);
			this.groupBoxFont.Controls.Add(this.butCalculateActual);
			this.groupBoxFont.Controls.Add(this.label3);
			this.groupBoxFont.Controls.Add(this.label7);
			this.groupBoxFont.Controls.Add(this.textFontApparent);
			this.groupBoxFont.Location = new System.Drawing.Point(30, 106);
			this.groupBoxFont.Name = "groupBoxFont";
			this.groupBoxFont.Size = new System.Drawing.Size(291, 89);
			this.groupBoxFont.TabIndex = 164;
			this.groupBoxFont.Text = "Font (decimals are allowed)";
			// 
		...
		private UI.GroupBox groupBoxFont;
