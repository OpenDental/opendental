...
namespace OpenDental {
	public partial class FormWikiEdit:FormODBase {
		...
		private void Bookmark_Click() {
			using FormExternalLink formExternalLink=new FormExternalLink(Lan.g(this,"Insert Internal Bookmark"),Lan.g(this,"ID"));
			...
			if(formExternalLink.URL=="" && formExternalLink.DisplayText=="") {
				...
				textContent.SelectionLength=0;
				textContent.SelectedText="<a href=\"#"+formExternalLink.URL+"\">"+formExternalLink.DisplayText+"</a>\n<div id=\""+formExternalLink.URL+"\"></div>";
			}
			textContent.Focus();
		}
