	...
	public partial class FormBilling : FormODBase {
		...
		private void FillComboEmail() {
			...
			if(emailAddressMe!=null) {
				...
				comboEmailFrom.Items.Add(Lan.g(this,"Me")+" <"+emailAddressMe.EmailUsername+">");//Just below Practice/Clinic
			}
			...
			for(int i=0;i<_listEmailAddresses.Count;i++) {
				if(emailAddressMe==null || _listEmailAddresses[i]!=emailAddressMe) {
		...
		///<summary>Runs aging. Changes to this method will also need to be made to OpenDentalService.ScheduledProcessThread.RunAgingEnterprise().</summary>
