...
namespace OpenDental {
    ...
    "t\'s edit form.";
			...
			this.textNotes.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.Referral;
			...
			this.textDisplayNote.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.Referral;
			...
			this.comboClinicPicker.IsMultiSelect = true;
