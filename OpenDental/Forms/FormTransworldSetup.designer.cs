namespace OpenDental{
	partial class FormTransworldSetup {
		...
		private void InitializeComponent() {
			...
			this.groupClinicSettings = new OpenDental.UI.GroupBoxOD();
			...
			this.groupServicesEnabled = new OpenDental.UI.GroupBoxOD();
			...
			this.groupSftpServerInfo = new OpenDental.UI.GroupBoxOD();
			this.labelSftpPort = new System.Windows.Forms.Label();
			this.textSftpPort = new OpenDental.ValidNum();
			this.groupClientIDs = new OpenDental.UI.GroupBoxOD();
			...
			this.groupSendActivity = new OpenDental.UI.GroupBoxOD();
			...
			this.comboSendFrequencyUnits = new OpenDental.UI.ComboBoxOD();
    ...
    " and login credentials for that clinic.";
		...
		private OpenDental.UI.GroupBoxOD groupClinicSettings;
		...
		private OpenDental.UI.GroupBoxOD groupSftpServerInfo;
		private OpenDental.UI.GroupBoxOD groupClientIDs;
		...
		private OpenDental.UI.GroupBoxOD groupSendActivity;
		private System.Windows.Forms.NumericUpDown numericSendFrequency;
		private OpenDental.UI.ComboBoxOD comboSendFrequencyUnits;
		private System.Windows.Forms.Label labelSendFrequency;
		private OpenDental.UI.GroupBoxOD groupServicesEnabled;
