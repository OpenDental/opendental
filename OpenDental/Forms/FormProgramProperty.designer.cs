...
namespace OpenDental {
	public partial class FormProgramProperty {
		...
		private void InitializeComponent()
		{
			...
			this.checkIsHighSecurity = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// butCancel
			// 
			...
			// checkIsHighSecurity
			// 
			this.checkIsHighSecurity.FlatStyle = System.Windows.Forms.FlatStyle.System;
			...
			this.checkIsHighSecurity.UseVisualStyleBackColor = false;
		...
		private CheckBox checkIsHighSecurity;
	}
}
