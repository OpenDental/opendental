namespace OpenDental {
	partial class FormClaimAttachmentDXC {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormClaimAttachmentDXC));
    ...
    "the first image category.";
			...
			this.Name = "FormClaimAttachmentDXC";
			this.Text = "Claim Attachments";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormClaimAttachmentDXC_FormClosed);
			this.Load += new System.EventHandler(this.FormClaimAttachmentDXC_Load);
			this.Shown += new System.EventHandler(this.FormClaimAttachmentDXC_Shown);
