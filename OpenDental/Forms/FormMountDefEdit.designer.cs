...
namespace OpenDental {
	public partial class FormMountDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkAdjModeAfterSeries = new System.Windows.Forms.CheckBox();
			this.checkFlipOnAcquire = new System.Windows.Forms.CheckBox();
			this.comboDefaultCat = new OpenDental.UI.ComboBoxOD();
			...
			this.panelSplitter.Controls.Add(this.checkTransparent);
			this.panelSplitter.Controls.Add(this.checkAdjModeAfterSeries);
			this.panelSplitter.Controls.Add(this.checkFlipOnAcquire);
			this.panelSplitter.Controls.Add(this.comboDefaultCat);
			this.panelSplitter.Controls.Add(this.label13);
			this.panelSplitter.Controls.Add(this.groupBoxOD1);
			this.panelSplitter.Controls.Add(this.groupBox1);
			this.panelSplitter.Controls.Add(this.butAdd);
			this.panelSplitter.Controls.Add(this.butColorTextBack);
			this.panelSplitter.Controls.Add(this.label2);
			this.panelSplitter.Controls.Add(this.label9);
			this.panelSplitter.Controls.Add(this.label1);
			this.panelSplitter.Controls.Add(this.butGenerate);
			this.panelSplitter.Controls.Add(this.butDelete);
			this.panelSplitter.Controls.Add(this.butColorFore);
			this.panelSplitter.Controls.Add(this.label8);
			this.panelSplitter.Controls.Add(this.butColorBack);
			...
			this.checkAdjModeAfterSeries.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkAdjModeAfterSeries.UseVisualStyleBackColor = true;
			// 
			// checkFlipOnAcquire
			// 
			...
			this.checkFlipOnAcquire.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkFlipOnAcquire.UseVisualStyleBackColor = true;
			// 
			// comboDefaultCat
			// 
    ...
    " Mount.  Consider enlarging your mount to find it.";
			...
			this.checkTransparent.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
		...
		private UI.ComboBoxOD comboDefaultCat;
		private CheckBox checkFlipOnAcquire;
		private CheckBox checkAdjModeAfterSeries;
		private CheckBox checkTransparent;
	}
}
