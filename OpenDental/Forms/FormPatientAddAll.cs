...
namespace OpenDental {
	public partial class FormPatientAddAll:FormODBase {
		...
		private void SetGenderListBox(UI.ListBox listBox) {
			...
			for(int i=0;i<listRequiredFieldConditions.Count;i++) {
				...
				switch(listRequiredFieldConditions[i].ConditionType) {
					...
					case RequiredFieldName.Gender:
						...
						List<UI.ListBox> listBoxesGender = new List<UI.ListBox>();
		...
		private void SetRequiredTextBoxNonGuarantor(Label label,System.Windows.Forms.TextBox textBoxFName,System.Windows.Forms.TextBox textBoxLName,System.Windows.Forms.TextBox textBoxRequired,
			bool areConditionsMet) 
		{
		...
		private void SetRequiredListBoxOD(Label label,UI.ListBox listBox,bool areConditionsMet,int disallowedIdx,string errorMsg,
			ErrorIconAlignment errorIconAlignment=ErrorIconAlignment.MiddleRight) {
			if(areConditionsMet) {
				label.Text=label.Text.Replace("*","")+"*";
		...
		private void SetRequiredListOrComboControlNonGuarantor(Label label,System.Windows.Forms.TextBox textBoxFName,System.Windows.Forms.TextBox textBoxLName,Control controlRequired,
		...
		private void SetRequiredListBoxODNonGuarantor(Label label,System.Windows.Forms.TextBox textBoxFName,System.Windows.Forms.TextBox textBoxLName,UI.ListBox listBoxRequired,
			bool areConditionsMet,int disallowedIdx,string errorMsg,ErrorIconAlignment errorIconAlignment=ErrorIconAlignment.MiddleRight) {
			if(!string.IsNullOrWhiteSpace(textBoxFName.Text) || !string.IsNullOrWhiteSpace(textBoxLName.Text)) {
		...
		private void SetLname(System.Windows.Forms.TextBox textLname,System.Windows.Forms.TextBox textFname,string fnameOld) {
		...
		private void SetEmail(System.Windows.Forms.TextBox textEmail,System.Windows.Forms.TextBox textFname,string emailOld) {
		...
		private void SetWirelessPhone(System.Windows.Forms.TextBox textPhone,System.Windows.Forms.TextBox textFname) {
			if(textFname.Text=="") {
				textPhone.Text="";
			}
		...
		private void textSSN_Validating(object sender,System.ComponentModel.CancelEventArgs e) {
			System.Windows.Forms.TextBox textSSN=(System.Windows.Forms.TextBox)sender;
		...
		private void FillListPatStatus(UI.ListBox listBox) {
			listBox.Items.Clear();
		...
		private void textZip_Validating(object sender, System.ComponentModel.CancelEventArgs e) {
			...
			textCity.Text=formZipSelect.ZipCodeSelected.City;
			textState.Text=formZipSelect.ZipCodeSelected.State;
			textZip.Text=formZipSelect.ZipCodeSelected.ZipCodeDigits;
		}
