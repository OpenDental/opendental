...
namespace OpenDental {
	public partial class FormWebChatTools:FormODBase {
		...
		private void gridWebChatSessions_CellDoubleClick(object sender,UI.ODGridClickEventArgs e) {
			FormWebChatSession formWebChatSession=new FormWebChatSession((WebChatSession)gridWebChatSessions.ListGridRows[e.Row].Tag,
				() => {
		...
		private void FillGridWebChats() {
			...
			ODException.SwallowAnyException(() => {
				listWebChatSessions=WebChatSessions.GetSessions(checkShowEndedSessions.Checked,dateRangeWebChat.GetDateTimeFrom(),dateRangeWebChat.GetDateTimeTo());
