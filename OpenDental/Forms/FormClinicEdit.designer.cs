...
namespace OpenDental {
	public partial class FormClinicEdit {
		...
		private void InitializeComponent()
		{
			...
			this.comboRegion = new OpenDental.UI.ComboBoxOD();
			...
			this.comboInsAutoReceiveNoAssign = new OpenDental.UI.ComboBoxOD();
    ...
    "ddress.";
			...
			this.butOK.Location = new System.Drawing.Point(972, 417);
			...
			this.butCancel.Location = new System.Drawing.Point(1053, 417);
		...
		private OpenDental.UI.ComboBoxOD comboRegion;
		...
		private UI.ComboBoxOD comboInsAutoReceiveNoAssign;
	}
}
