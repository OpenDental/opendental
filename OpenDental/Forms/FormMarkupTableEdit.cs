...
namespace OpenDental {
	public partial class FormMarkupTableEdit:FormODBase {
		...
		private void butHeaders_Click(object sender,EventArgs e) {
			...
			formWikiTableHeaders.ListColNames=_listColNames;//Just passes the reference to the list in memory, so no need to "collect" the changes afterwords.
			formWikiTableHeaders.ListColWidths=_listColWidths;//Just passes the reference to the list in memory, so no need to "collect" the changes afterwords.
