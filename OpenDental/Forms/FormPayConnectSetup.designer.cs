...
namespace OpenDental {
	public partial class FormPayConnectSetup {
		...
		private void InitializeComponent()
		{
			...
			this.comboDefaultProcessing = new OpenDental.UI.ComboBoxOD();
    ...
    "";
		...
		private OpenDental.UI.ComboBoxOD comboPaymentType;
		...
		private OpenDental.UI.GroupBoxOD groupPaySettings;
		...
		private OpenDental.UI.ComboBoxOD comboDefaultProcessing;
