...
namespace OpenDental {
	public partial class FormWikiListEdit:FormODBase {
		...
		private void butAdvSearch_Click(object sender,EventArgs e) {
			...
			using FormWikiListAdvancedSearch formWikiListAdvancedSearch=new FormWikiListAdvancedSearch(_listWikiListHeaderWidths);
			formWikiListAdvancedSearch.IntArrayColumnIndicesSelected=_intArrayIdxsSearchCol;
			if(formWikiListAdvancedSearch.ShowDialog()==DialogResult.OK) {
				_intArrayIdxsSearchCol=formWikiListAdvancedSearch.IntArrayColumnIndicesSelected;
				FillGrid();
			}
