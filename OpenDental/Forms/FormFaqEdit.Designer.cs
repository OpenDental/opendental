namespace OpenDental {
	partial class FormFaqEdit {
		...
		private void InitializeComponent() {
			...
			this.checkSticky = new OpenDental.UI.CheckBox();
			...
			this.listAvailableManualPages = new OpenDental.UI.ListBox();
			this.butRight = new System.Windows.Forms.Button();
			this.butLeft = new System.Windows.Forms.Button();
			this.label3 = new System.Windows.Forms.Label();
			this.listBoxLinkedPages = new OpenDental.UI.ListBox();
		...
		private OpenDental.UI.CheckBox checkSticky;
		...
		private OpenDental.UI.ListBox listAvailableManualPages;
		private System.Windows.Forms.Button butRight;
		private System.Windows.Forms.Button butLeft;
		private System.Windows.Forms.Label label3;
		private OpenDental.UI.ListBox listBoxLinkedPages;
