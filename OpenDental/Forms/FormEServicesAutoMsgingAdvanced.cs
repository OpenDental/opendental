...
namespace OpenDental {
	public partial class FormEServicesAutoMsgingAdvanced:FormODBase {
		...
		private void FillGrid() {
			...
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Send eConfirmation"),80,HorizontalAlignment.Center) { Tag=_listDontSendConfNums });
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Change eConfirmation Status"),120,HorizontalAlignment.Center) { Tag=_listDontChangeConfNums });
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Send eReminder"),90,HorizontalAlignment.Center) { Tag=_listDontSendReminderNums});
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Send Automated Thank-You"),115,HorizontalAlignment.Center) { Tag=_listExcludeThanksNums});
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Send Arrival SMS"),110,HorizontalAlignment.Center) { Tag=_listExcludeArrivalSendNums});
			...
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Enable BYOD"),70,HorizontalAlignment.Center) { Tag=_listByodEnabledNums});
