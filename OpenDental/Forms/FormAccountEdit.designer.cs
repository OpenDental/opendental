...
namespace OpenDental {
	public partial class FormAccountEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listAcctType = new OpenDental.UI.ListBox();
			...
			this.checkRetainedEarnings = new OpenDental.UI.CheckBox();
			this.labelRetainedEarnings = new System.Windows.Forms.Label();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.butDelete.Location = new System.Drawing.Point(28, 312);
			...
			this.butOK.Location = new System.Drawing.Point(471, 312);
			...
			this.butCancel.Location = new System.Drawing.Point(552, 312);
			...
			// 
			this.checkRetainedEarnings.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkRetainedEarnings.Location = new System.Drawing.Point(28, 229);
			this.checkRetainedEarnings.Name = "checkRetainedEarnings";
			this.checkRetainedEarnings.Size = new System.Drawing.Size(192, 20);
			this.checkRetainedEarnings.TabIndex = 23;
			this.checkRetainedEarnings.Text = "Retained Earnings";
			// 
			// labelRetainedEarnings
			// 
			this.labelRetainedEarnings.Location = new System.Drawing.Point(226, 215);
			this.labelRetainedEarnings.Name = "labelRetainedEarnings";
			this.labelRetainedEarnings.Size = new System.Drawing.Size(401, 59);
			this.labelRetainedEarnings.TabIndex = 24;
			this.labelRetainedEarnings.Text = resources.GetString("labelRetainedEarnings.Text");
			// 
			// FormAccountEdit
			// 
			this.ClientSize = new System.Drawing.Size(653, 356);
			this.Controls.Add(this.labelRetainedEarnings);
			this.Controls.Add(this.checkRetainedEarnings);
		...
		private UI.ListBox listAcctType;
		private OpenDental.UI.CheckBox checkInactive;
		private Button butColor;
		private Label label4;
		private OpenDental.UI.Button butCancel;
		private OpenDental.UI.Button butOK;
		private OpenDental.UI.CheckBox checkRetainedEarnings;
		private Label labelRetainedEarnings;
	}
}
