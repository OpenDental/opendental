...
namespace OpenDental {
	public partial class FormProcCodes {
		...
		private void InitializeComponent() {
			...
			this.comboSort = new OpenDental.UI.ComboBoxOD();
			...
			this.groupProcCodeSetup = new OpenDental.UI.GroupBoxOD();
			...
			this.comboProvider1 = new OpenDental.UI.ComboBoxOD();
			...
			this.comboProvider2 = new OpenDental.UI.ComboBoxOD();
			...
			this.comboProvider3 = new OpenDental.UI.ComboBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupProcCodeSetup;
		private OpenDental.UI.GroupBoxOD groupBox2;
		private OpenDental.UI.ComboBoxOD comboProvider1;
		...
		private OpenDental.UI.ComboBoxOD comboProvider2;
		...
		private OpenDental.UI.ComboBoxOD comboProvider3;
		...
		private OpenDental.UI.ComboBoxOD comboSort;
