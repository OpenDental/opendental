...
namespace OpenDental {
	///<summary></summary>
	public partial class FormClaimAttachmentDXC:FormODBase {
		...
		public FormClaimAttachmentDXC(Claim claim) {
			InitializeComponent();
		...
		private void FormClaimAttachmentDXC_Load(object sender,EventArgs e) {
			if(_isAlreadyOpen) {
		...
		private void FormClaimAttachmentDXC_Shown(object sender,EventArgs e) {
			FillGrid();
		...
		private void FormClaimAttachmentDXC_FormClosed(object sender,FormClosedEventArgs e) {
