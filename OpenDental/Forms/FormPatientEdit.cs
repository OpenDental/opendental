...
///<summary></summary>
	public partial class FormPatientEdit : FormODBase {
		...
		private void FormPatientEdit_Load(object sender, System.EventArgs e) {
			...
			comboPreferredPronouns.SetSelectedEnum(_patientNoteCur.Pronoun);
...
;						break;
		...
		private void SetRequiredComboBoxOD(Label labelCur,ComboBoxOD comboBoxCur,bool areConditionsMet,int disallowedIdx,string errorMsg) {
		...
		private void SetRequiredComboBoxOD(Label labelCur,ComboBoxOD comboBoxCur,bool areConditionsMet,List<int> listDisallowedIndices,string errorMsg) {
		...
		private void textCounty_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e) {
			...
			countiesArray=Counties.Refresh(textCounty.Text).ToArray();
			//similarSchools=
		...
		private void butOK_Click(object sender ,System.EventArgs e) {
			...
			switch(listGender.SelectedIndex){
				...
				case 2: _patientCur.Gender=PatientGender.Other; break;
				case 3: _patientCur.Gender=PatientGender.Unknown; break;
			}
			if(PrefC.GetBool(PrefName.ShowPreferredPronounsForPats)) {//Only set when preference is enabled.
				_patientNoteCur.Pronoun=comboPreferredPronouns.GetSelected<PronounPreferred>();
			}
			switch(comboPreferredPronouns.SelectedIndex) {
				case 0: _patientNoteCur.Pronoun=PronounPreferred.None; break;
				case 1: _patientNoteCur.Pronoun=PronounPreferred.HeHim; break;
				case 2: _patientNoteCur.Pronoun=PronounPreferred.SheHer; break;
				case 3: _patientNoteCur.Pronoun=PronounPreferred.TheyThem; break;
			}
