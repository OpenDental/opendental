...
namespace OpenDental {
	...
	public partial class FormSheetDefEdit:FormODBase {
		...
		private bool PromptUpdateEClipboardSheetDefs() {
			List<EClipboardSheetDef> listEClipboardSheetDefs = EClipboardSheetDefs.GetAllForSheetDefForOnceRule(_sheetDefCur.SheetDefNum);
			...
			foreach(EClipboardSheetDef eClipboardSheetDef in listEClipboardSheetDefs) {
				eClipboardSheetDef.PrefillStatusOverride=_sheetDefCur.RevID;
