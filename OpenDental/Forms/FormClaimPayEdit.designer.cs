...
namespace OpenDental {
	public partial class FormClaimPayEdit {
		...
		private void InitializeComponent(){
			...
			this.groupPrepaid = new OpenDental.UI.GroupBoxOD();
			this.butPaySimple = new System.Windows.Forms.Panel();
			this.butPayConnect = new OpenDental.UI.Button();
			this.groupBoxDeposit = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupPrepaid;
		private UI.Button butPayConnect;
		private OpenDental.UI.GroupBoxOD groupBoxDeposit;
