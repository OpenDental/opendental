namespace OpenDental {
	partial class FormProcEdit {
		...
		private void InitializeComponent() {
			...
			this.groupQuadrant = new OpenDental.UI.GroupBoxOD();
			...
			this.groupArch = new OpenDental.UI.GroupBoxOD();
			...
			this.groupSextant = new OpenDental.UI.GroupBoxOD();
			...
			this.comboDrugUnit = new OpenDental.UI.ComboBoxOD();
			...
			this.comboDx = new OpenDental.UI.ComboBoxOD();
			this.comboProv = new OpenDental.UI.ComboBoxOD();
			this.textUser = new System.Windows.Forms.TextBox();
			this.comboBillingTypeTwo = new OpenDental.UI.ComboBoxOD();
			this.labelBillingTypeTwo = new System.Windows.Forms.Label();
			this.comboBillingTypeOne = new OpenDental.UI.ComboBoxOD();
			...
			this.groupCanadianProcTypeCode = new OpenDental.UI.GroupBoxOD();
			...
			this.comboUnitType = new OpenDental.UI.ComboBoxOD();
    ...
    " to edit.";
		...
		private OpenDental.UI.GroupBoxOD groupQuadrant;
		...
		private OpenDental.UI.ComboBoxOD comboDx;
		...
		private OpenDental.UI.ComboBoxOD comboBillingTypeTwo;
		private System.Windows.Forms.Label labelBillingTypeTwo;
		private OpenDental.UI.ComboBoxOD comboBillingTypeOne;
		...
		private OpenDental.UI.GroupBoxOD groupCanadianProcTypeCode;
		...
		private OpenDental.UI.ComboBoxOD comboPrognosis;
		private System.Windows.Forms.Label labelPrognosis;
		private UI.ComboBoxOD comboProcStatus;
		private OpenDental.UI.ComboBoxOD comboDrugUnit;
		...
		private OpenDental.UI.ComboBoxOD comboUnitType;
