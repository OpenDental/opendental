namespace OpenDental{
	partial class FormEServicesWebSchedRecall {
		...
		private void InitializeComponent() {
			...
			this.groupWebSchedProvRule = new OpenDental.UI.GroupBoxOD();
			...
			this.comboWebSchedClinic = new OpenDental.UI.ComboBoxOD();
			this.comboWebSchedRecallTypes = new OpenDental.UI.ComboBoxOD();
    ...
    "d.";
		...
		private OpenDental.UI.GroupBoxOD groupWebSchedProvRule;
		...
		private OpenDental.UI.GroupBoxOD groupBoxWebSchedAutomation;
		...
		private OpenDental.UI.GroupBoxOD groupWebSchedPreview;
		private UI.Button butWebSchedPickClinic;
		private UI.Button butWebSchedPickProv;
		private System.Windows.Forms.Label label22;
		private OpenDental.UI.ComboBoxOD comboWebSchedProviders;
		...
		private OpenDental.UI.ComboBoxOD comboWebSchedClinic;
		private OpenDental.UI.ComboBoxOD comboWebSchedRecallTypes;
