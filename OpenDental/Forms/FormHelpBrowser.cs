...
namespace OpenDental {
	public partial class FormHelpBrowser:FormODBase {
		...
		private void ManageToolStripMenuItem_Click(object sender,EventArgs e) {
			if(_formFaqEdit!=null && !_formFaqEdit.IsDisposed) {//FormFaqEdit currently opened.
		...
		private void toolStripFaqQuickAdd_Click(object sender,EventArgs e) {
			if(_formFaqPicker!=null && !_formFaqPicker.IsDisposed) {//FormFaqPicker currently opened.
