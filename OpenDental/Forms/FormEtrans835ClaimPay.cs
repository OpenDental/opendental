	...
	public partial class FormEtrans835ClaimPay : FormODBase {
		...
		private void FillGridProcedures(){
			...
			if(PrefC.GetYN(PrefName.ClaimEditShowPayTracking)) {
				...
				gridPayments.Columns.Add(new GridColumn(Lan.g("TableClaimProc","Pay Tracking"),90) { ListDisplayStrings=listDefDescripts,DropDownWidth=160 });
				claimPaymentTrackingIndex=gridPayments.Columns.Count-1;
			}
		...
		private void butOK_Click(object sender,System.EventArgs e) {
			...
			FeeL.SaveAllowedFeesFromClaimPayment(listClaimProcs,_listPlans);
