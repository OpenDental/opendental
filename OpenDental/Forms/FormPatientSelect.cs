      ...
      if(ODBuild.IsThinfinity()) {
		...
		private int TextBoxCharCount() {
			...
			return UIHelper.GetAllControls(this)
				.OfType<System.Windows.Forms.TextBox>()//ValidPhone is a TextBox
		...
		private void textBox_Enter(object sender,EventArgs e) {
			textSelected=(System.Windows.Forms.TextBox)sender;
		}

		/// <summary>Sets the handler for all of the Form's TextBox Enter Events</summary>
		private void SetAllTextBoxEnterEventListeners() {
			List<System.Windows.Forms.TextBox> listTextboxes = UIHelper.GetAllControls(this).OfType<System.Windows.Forms.TextBox>().ToList();
