...
namespace OpenDental {
	public partial class FormPrinterSetup {
		...
		private void InitializeComponent(){
			...
			this.comboDefault = new OpenDental.UI.ComboBoxOD();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.comboLabelSheet = new OpenDental.UI.ComboBoxOD();
			this.label4 = new System.Windows.Forms.Label();
			this.comboClaim = new OpenDental.UI.ComboBoxOD();
			this.label5 = new System.Windows.Forms.Label();
			this.comboRx = new OpenDental.UI.ComboBoxOD();
			this.label6 = new System.Windows.Forms.Label();
			this.comboTPPerio = new OpenDental.UI.ComboBoxOD();
			this.labelTPandPerio = new System.Windows.Forms.Label();
			this.comboStatement = new OpenDental.UI.ComboBoxOD();
			this.label8 = new System.Windows.Forms.Label();
			this.comboLabelSingle = new OpenDental.UI.ComboBoxOD();
			this.label9 = new System.Windows.Forms.Label();
			this.comboPostcard = new OpenDental.UI.ComboBoxOD();
			...
			this.comboAppointments = new OpenDental.UI.ComboBoxOD();
    ...
    "ing a default, it is not necessary to check the box.";
		...
		private OpenDental.UI.ComboBoxOD comboDefault;
		...
		private OpenDental.UI.ComboBoxOD comboLabelSheet;
		private System.Windows.Forms.Label label8;
		private System.Windows.Forms.Label label9;
		private OpenDental.UI.ComboBoxOD comboLabelSingle;
		private OpenDental.UI.ComboBoxOD comboPostcard;
		private OpenDental.UI.ComboBoxOD comboClaim;
		private OpenDental.UI.ComboBoxOD comboRx;
		private OpenDental.UI.ComboBoxOD comboStatement;
		private OpenDental.UI.ComboBoxOD comboTPPerio;
		...
		private OpenDental.UI.ComboBoxOD comboAppointments;
		...
		private OpenDental.UI.ComboBoxOD comboRxControlled;
		private OpenDental.UI.ComboBoxOD comboReceipt;
		private Label label14;
		private CheckBox checkReceipt;
		private Label labelRxMulti;
		private CheckBox checkRxMulti;
		private OpenDental.UI.ComboBoxOD comboRxMulti;
	}
}
