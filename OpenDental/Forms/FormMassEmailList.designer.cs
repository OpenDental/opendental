namespace OpenDental{
	partial class FormMassEmailList {
		...
		private void InitializeComponent() {
			...
			this.checkCustomQuery = new System.Windows.Forms.CheckBox();
    ...
    "column.";
			...
			// checkCustomQuery
			// 
			this.checkCustomQuery.Location = new System.Drawing.Point(9, 345);
			this.checkCustomQuery.Name = "checkCustomQuery";
			this.checkCustomQuery.Size = new System.Drawing.Size(131, 17);
			this.checkCustomQuery.TabIndex = 226;
			this.checkCustomQuery.Text = "Use Custom Query";
			this.checkCustomQuery.UseVisualStyleBackColor = true;
			this.checkCustomQuery.Click += new System.EventHandler(this.checkCustomQuery_Click);
			// 
			// butSetSelected
			// 
			...
			this.Controls.Add(this.checkCustomQuery);
    ...
    private UI.Button butClose;
		...
		private System.Windows.Forms.CheckBox checkCustomQuery;
