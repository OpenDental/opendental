...
namespace OpenDental{
	...
	public partial class FormScreenGroupEdit:FormODBase {
		...
		private void FormScreenGroup_Load(object sender, System.EventArgs e) {
			...
			comboCounty.Items.AddList(CountiesListNames);
		...
		private void butAddPat_Click(object sender,EventArgs e) {
			...
			if(FormPS.DialogResult==DialogResult.OK) {
				ScreenPat screenPat=_listScreenPats.FirstOrDefault(x => x.PatNum==FormPS.PatNumSelected);
				if(screenPat!=null) {
				...
				screenPat.PatNum=FormPS.PatNumSelected;
