	...
	public partial class FormFeeSchedTools :FormODBase {
		...
		private void butImportCanada_Click(object sender,EventArgs e) {
			...
			if(formPick.IsFileChosenProtected) {
				...
				using FormFeeSchedPickAuthOntario formAuth=new FormFeeSchedPickAuthOntario(formPick.GetSelectedFeeDA());
				...
				string memberNumberODA=formAuth.ODAMemberNumber;
				string memberPasswordODA=formAuth.ODAMemberPassword;
