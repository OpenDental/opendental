...
namespace OpenDental {
	public partial class FormFeesForIns {
		...
		private void InitializeComponent()
		{
			...
			this.comboFeeSchedWithout = new OpenDental.UI.ComboBoxOD();
			this.label3 = new System.Windows.Forms.Label();
			this.comboFeeSchedWith = new OpenDental.UI.ComboBoxOD();
			this.label4 = new System.Windows.Forms.Label();
			this.comboFeeSchedNew = new OpenDental.UI.ComboBoxOD();
    ...
    "ched.";
		...
		private OpenDental.UI.ComboBoxOD comboFeeSchedWithout;
		private Label label3;
		private OpenDental.UI.ComboBoxOD comboFeeSchedWith;
		private Label label4;
		private OpenDental.UI.ComboBoxOD comboFeeSchedNew;
