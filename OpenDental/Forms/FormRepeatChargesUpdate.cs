...
namespace OpenDental{
	...
	public partial class FormRepeatChargesUpdate :FormODBase{
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			if(!string.IsNullOrEmpty(result.ErrorMsg.ToString())) {
				SecurityLogs.MakeLogEntry(Permissions.RepeatChargeTool,0,"Repeat Charge Tool Error: "+result.ErrorMsg.ToString());
