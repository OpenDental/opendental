namespace OpenDental {
	partial class FormRecallList {
		...
		private void InitializeComponent()
		{
			...
			this.groupEmailFromRecalls = new OpenDental.UI.GroupBoxOD();
			this.comboEmailFromRecalls = new OpenDental.UI.ComboBoxOD();
			...
			this.groupSetStatusRecalls = new OpenDental.UI.GroupBoxOD();
			...
			this.groupViewRecalls = new OpenDental.UI.GroupBoxOD();
			...
			this.groupViewRemind = new OpenDental.UI.GroupBoxOD();
			...
			this.groupEmailFromReact = new OpenDental.UI.GroupBoxOD();
			this.comboEmailFromReact = new OpenDental.UI.ComboBoxOD();
			...
			this.groupSetStatusReact = new OpenDental.UI.GroupBoxOD();
			this.comboSetStatusReact = new OpenDental.UI.ComboBoxOD();
			this.butSetStatusReact = new OpenDental.UI.Button();
			this.groupViewReact = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupEmailFromRecalls;
		private OpenDental.UI.ComboBoxOD comboEmailFromRecalls;
		...
		private OpenDental.UI.GroupBoxOD groupSetStatusRecalls;
		...
		private OpenDental.UI.GroupBoxOD groupViewRecalls;
		...
		private OpenDental.UI.GroupBoxOD groupViewRemind;
		...
		private OpenDental.UI.GroupBoxOD groupSetStatusReact;
		private OpenDental.UI.Button butSetStatusReact;
		private OpenDental.UI.GroupBoxOD groupViewReact;
		...
		private OpenDental.UI.GroupBoxOD groupEmailFromReact;
		private OpenDental.UI.ComboBoxOD comboEmailFromReact;
