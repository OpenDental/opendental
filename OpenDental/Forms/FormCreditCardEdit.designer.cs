namespace OpenDental{
	partial class FormCreditCardEdit {
		...
		private void InitializeComponent() {
			...
			this.groupChargeFrequency = new OpenDental.UI.GroupBoxOD();
			this.comboDays = new OpenDental.UI.ComboBoxOD();
			...
			this.groupProcedures = new OpenDental.UI.GroupBoxOD();
			...
			this.comboPaymentPlans = new OpenDental.UI.ComboBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupChargeFrequency;
		...
		private OpenDental.UI.ComboBoxOD comboDays;
		private OpenDental.UI.ComboBoxOD comboFrequency;
