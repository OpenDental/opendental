namespace OpenDental {
	partial class FormApptEdit {
		...
		private void InitializeComponent() {
			...
			this.comboConfirmed = new OpenDental.UI.ComboBoxOD();
			this.comboUnschedStatus = new OpenDental.UI.ComboBoxOD();
			...
			this.comboAssistant = new OpenDental.UI.ComboBoxOD();
			...
			this.comboApptType = new OpenDental.UI.ComboBoxOD();
		...
		private OpenDental.UI.ComboBoxOD comboConfirmed;
		private OpenDental.UI.ComboBoxOD comboUnschedStatus;
		...
		private OpenDental.UI.ComboBoxOD comboAssistant;
		private OpenDental.UI.ComboBoxOD comboProvHyg;
		...
		private UI.ComboBoxOD comboApptType;
