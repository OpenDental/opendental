...
namespace OpenDental{
	...
	public partial class FormBillingOptions : FormODBase {
		...
		///<summary>Runs aging. Returns false if there are any errors while running aging. This logic is used in OpenDentalService.ScheduledProcessThread.TryRunningAging().Any changes to this method will also need to be made there, if they apply.</summary>
		private bool TryRunningAging() {
