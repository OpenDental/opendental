namespace OpenDental{
	partial class FormRequestEdit {
		...
		private void InitializeComponent() {
			...
			this.groupMyVotes = new OpenDental.UI.GroupBoxOD();
			...
			this.comboApproval = new OpenDental.UI.ComboBoxOD();
    ...
    ".  Try to prepend your name to the note.";
		...
		private OpenDental.UI.GroupBoxOD groupMyVotes;
		...
		private OpenDental.UI.ComboBoxOD comboApproval;
