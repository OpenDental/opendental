namespace OpenDental {
	partial class FormUpdate {
		...
		private void InitializeComponent() {
			...
			this.groupBuild = new OpenDental.UI.GroupBoxOD();
			...
			this.groupBeta = new OpenDental.UI.GroupBoxOD();
			...
			this.groupStable = new OpenDental.UI.GroupBoxOD();
			...
			this.groupAlpha = new OpenDental.UI.GroupBoxOD();
    ...
    "ersion only if you demand the latest features.  Be sure to update regularly.";
		...
		private OpenDental.UI.GroupBoxOD groupAlpha;
