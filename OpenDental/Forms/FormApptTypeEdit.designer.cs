namespace OpenDental{
	partial class FormApptTypeEdit {
		...
		private void InitializeComponent() {
			...
			this.listBoxProcCodesRequired = new OpenDental.UI.ListBoxOD();
			this.butAddRequired = new OpenDental.UI.Button();
			this.butRemoveRequired = new OpenDental.UI.Button();
			this.listBoxBlockoutTypes = new OpenDental.UI.ListBoxOD();
			...
			this.labelBlockoutTypes.Text = "Appointments are only allowed on these Blockout Types";
		...
		private UI.ListBoxOD listBoxProcCodesRequired;
        private UI.Button butAddRequired;
        private UI.Button butRemoveRequired;
        private UI.ListBoxOD listBoxBlockoutTypes;
