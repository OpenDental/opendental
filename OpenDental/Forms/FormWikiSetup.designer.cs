namespace OpenDental{
	partial class FormWikiSetup {
		...
		private void InitializeComponent() {
			...
			this.checkDetectLinks = new OpenDental.UI.CheckBox();
			this.checkCreatePageFromLinks = new OpenDental.UI.CheckBox();
			this.SuspendLayout();
			// 
			// butOK
			// 
		...
		private OpenDental.UI.CheckBox checkDetectLinks;
		private OpenDental.UI.CheckBox checkCreatePageFromLinks;
	}
}