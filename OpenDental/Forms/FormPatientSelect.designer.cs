...
namespace OpenDental {
	public partial class FormPatientSelect {
		...
		private void InitializeComponent()
		{
			...
			this.groupAddPt = new OpenDental.UI.GroupBox();
			...
			this.checkShowMerged = new OpenDental.UI.CheckBox();
			...
			this.checkShowArchived = new OpenDental.UI.CheckBox();
			...
			this.checkGuarantors = new OpenDental.UI.CheckBox();
			...
			this.butOK.Location = new System.Drawing.Point(858, 663);
		...
		private OpenDental.UI.GroupBox groupAddPt;
		private OpenDental.UI.CheckBox checkGuarantors;
		...
		private OpenDental.UI.CheckBox checkShowArchived;
		private TextBox textBirthdate;
		private Label label2;
		private OpenDental.UI.ComboBox comboBillingType;
		...
		private OpenDental.UI.CheckBox checkShowMerged;
