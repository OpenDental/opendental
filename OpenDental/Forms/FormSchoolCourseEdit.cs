...
namespace OpenDental{
	...
	/// </summary>
	public class FormSchoolCourseEdit : FormODBase {
    ...
    private SchoolCourse CourseCur;
		...
		private void InitializeComponent()
		{
			...
			this.FormClosing += new FormClosingEventHandler(this.FormSchoolCourseEdit_Closing);
		...
		private void FormSchoolCourseEdit_Closing(object sender, EventArgs e) {
