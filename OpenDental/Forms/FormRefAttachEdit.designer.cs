...
namespace OpenDental {
	public partial class FormRefAttachEdit {
		...
		private void InitializeComponent(){
			...
			this.listRefType = new OpenDental.UI.ListBox();
			this.checkIsTransitionOfCare = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.ListBox listRefType;
		private OpenDental.UI.CheckBox checkIsTransitionOfCare;
