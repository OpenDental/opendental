namespace OpenDental {
	partial class FormEhrLabResultEdit2014 {
		...
		private void InitializeComponent() {
			...
			this.groupUnitsOfMeasure = new OpenDental.UI.GroupBoxOD();
			...
			this.groupOrganization = new OpenDental.UI.GroupBoxOD();
			...
			this.groupSN = new OpenDental.UI.GroupBoxOD();
			...
			this.groupCE = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupUnitsOfMeasure;
		private OpenDental.UI.GroupBoxOD groupOrganization;
		...
		private OpenDental.UI.GroupBoxOD groupCE;
		...
		private OpenDental.UI.GroupBoxOD groupSN;
