namespace OpenDental{
	partial class FormInsVerificationList {
		...
		private void InitializeComponent() {
			...
			this.comboSetVerifyStatus = new OpenDental.UI.ComboBoxOD();
			...
			this.groupInsurancePlan = new OpenDental.UI.GroupBoxOD();
			...
			this.tabAssignStandard = new System.Windows.Forms.TabPage();
			this.butCloseStandard = new OpenDental.UI.Button();
			this.gridAssignStandard = new OpenDental.UI.GridOD();
			this.groupAssignVerificationStandard = new OpenDental.UI.GroupBoxOD();
			...
			this.tabAssignMedicaid = new System.Windows.Forms.TabPage();
			this.butCloseMedicaid = new OpenDental.UI.Button();
			this.butAssignUserMedicaid = new OpenDental.UI.Button();
			this.groupAssignVerificationMedicaid = new OpenDental.UI.GroupBoxOD();
			...
			this.groupVerificationFilters = new OpenDental.UI.GroupBoxOD();
			...
			this.comboVerifyUser = new OpenDental.UI.ComboBoxOD();
			this.labelPlanBenefitsNotVerifiedIn = new System.Windows.Forms.Label();
			this.labelClinic = new System.Windows.Forms.Label();
			this.comboFilterVerifyStatus = new OpenDental.UI.ComboBoxOD();
			...
			// labelPatBirthdate
			// 
			this.labelPatBirthdate.Location = new System.Drawing.Point(489, 458);
			...
			// labelSubscriberID
			// 
			this.labelSubscriberID.Location = new System.Drawing.Point(6, 79);
			...
			// labelSSN
			// 
			this.labelSSN.Location = new System.Drawing.Point(6, 57);
			...
			// labelBirthdate
			// 
			this.labelBirthdate.Location = new System.Drawing.Point(6, 35);
			...
			// labelPlanNote
			// 
			this.labelPlanNote.Location = new System.Drawing.Point(249, 11);
			...
			// labelCarrierPhone
			// 
			this.labelCarrierPhone.Location = new System.Drawing.Point(8, 33);
			...
			// labelGroupNumber
			// 
			this.labelGroupNumber.Location = new System.Drawing.Point(8, 99);
			...
			// labelGroupName
			// 
			this.labelGroupName.Location = new System.Drawing.Point(8, 77);
			...
			// labelEmployerName
			// 
			this.labelEmployerName.Location = new System.Drawing.Point(8, 55);
			...
			// labelCarrierName
			// 
			this.labelCarrierName.Location = new System.Drawing.Point(8, 12);
			...
			// tabAssignStandard
			// 
			this.tabAssignStandard.BackColor = System.Drawing.Color.Transparent;
			...
			this.tabAssignStandard.Location = new System.Drawing.Point(4, 22);
			this.tabAssignStandard.Name = "tabAssignStandard";
			this.tabAssignStandard.Padding = new System.Windows.Forms.Padding(3);
			this.tabAssignStandard.Size = new System.Drawing.Size(963, 515);
			...
			this.butCloseStandard.Location = new System.Drawing.Point(878, 486);
			...
			this.tabAssignMedicaid.Location = new System.Drawing.Point(4, 22);
			this.tabAssignMedicaid.Name = "tabAssignMedicaid";
			this.tabAssignMedicaid.Size = new System.Drawing.Size(963, 515);
			...
			this.butCloseMedicaid.Location = new System.Drawing.Point(878, 486);
			...
			this.textAppointmentScheduledDaysStandard.Name = "textAppointmentScheduledDays";
			...
			this.textPatientEnrollmentDaysStandard.Name = "textPatientEnrollmentDays";
			...
			this.textInsBenefitEligibilityDaysStandard.Name = "textInsBenefitEligibilityDays";
		...
		private OpenDental.UI.GroupBoxOD groupVerificationFilters;
		...
		private OpenDental.UI.GroupBoxOD groupInsurancePlan;
		...
		private OpenDental.UI.GroupBoxOD groupAssignVerificationStandard;
		...
		private OpenDental.UI.ComboBoxOD comboFilterVerifyStatus;
		...
		private System.Windows.Forms.TabPage tabAssignStandard;
		...
		private OpenDental.UI.ComboBoxOD comboVerifyUser;
		private System.Windows.Forms.Label labelVerifyStatusSet;
		private OpenDental.UI.ComboBoxOD comboSetVerifyStatus;
		...
		private System.Windows.Forms.TabPage tabAssignMedicaid;
		private UI.GroupBoxOD groupAssignVerificationMedicaid;
