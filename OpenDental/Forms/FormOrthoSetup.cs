...
namespace OpenDental {
	public partial class FormOrthoSetup:FormODBase {
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			if(Prefs.UpdateBool(PrefName.OrthoShowInChart,checkOrthoShowInChart.Checked)
			...
			| Prefs.UpdateBool(PrefName.OrthoDebondProcCompletedSetsMonthsTreat,checkDebondOverridesMonthsTreat.Checked)
