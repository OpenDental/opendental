	...
	public partial class FormClaimReports : FormODBase {
		...
		private void butRetrieve_Click(object sender,EventArgs e) {
			...
			if(!Directory.Exists(clearinghouseClin.ResponsePath)) {
				MsgBox.Show(this,"Clearinghouse does not have a valid Report Path set. Go To Setup > Family/Insurance > Clearinghouses > and double click desired clearinghouse to update path.");
				return;
			}
