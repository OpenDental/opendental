...
namespace OpenDental{
	...
	/// </summary>
	public class FormSchoolClassEdit : FormODBase {
    ...
    private SchoolClass ClassCur;
		...
		private void InitializeComponent()
		{
			...
			this.FormClosing += new FormClosingEventHandler(this.FormSchoolClassEdit_Closing);
		...
		private void FormSchoolClassEdit_Closing(object sender,EventArgs e) {
