...
namespace OpenDental{
	...
	public partial class FormStatementOptions : FormODBase {
		...
		private void LimitedCustomStatementLayoutHelper() {
			this.DisableAllExcept(butDelete,butPreview, butCancel, butOK, checkIntermingled,checkExportCSV,checkShowLName, checkExcludeTxfr, checkHidePayment,butPrint, butEmail,butPatPortal,textNote,textNoteBold, listMode);
