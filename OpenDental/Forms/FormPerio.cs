...
namespace OpenDental{
	...
	public partial class FormPerio : FormODBase {
		...
		public override void ProcessSignalODs(List<Signalod> listSignals) {
			...
			if(_isExamInUse && PerioExamCur!=null && listSignals.Any(x=>x.FKeyType==KeyType.PatNum && x.FKey==PerioExamCur.PatNum && x.IType==InvalidType.PerioExams)) {
		...
		private void CheckMobileActivity() {
			...
			bool isExamInUseCur=MobileAppDevices.IsInUse(MADPage.PerioExamEditPage,PatCur.PatNum) 
				|| MobileAppDevices.IsInUse(MADPage.PerioExamListPage,PatCur.PatNum)
				|| MobileAppDevices.IsInUse(MADPage.PerioExamOverviewPage,PatCur.PatNum)
				|| MobileAppDevices.IsInUse(MADPage.Undefined,PatCur.PatNum);
...
//		}
		...
		private void butUnlockEClip_Click(object sender,EventArgs e) {
			bool _isExamInUse=MobileAppDevices.IsInUse(MADPage.PerioExamEditPage,PatCur.PatNum) || MobileAppDevices.IsInUse(MADPage.PerioExamListPage,PatCur.PatNum);
