...
namespace OpenDental {
	public partial class FormEServicesWebSchedRecall:FormODBase {
		...
		private void FillGridWebSchedOperatories() {
			...
			gridWebSchedOperatories.Columns.Add(new GridColumn(Lan.g("TableOperatories","Op Name"),opNameWidth));
			gridWebSchedOperatories.Columns.Add(new GridColumn(Lan.g("TableOperatories","Abbrev"),70));
			if(PrefC.HasClinicsEnabled) {
				gridWebSchedOperatories.Columns.Add(new GridColumn(Lan.g("TableOperatories","Clinic"),clinicWidth));
			}
		...
		private void butProvRulePickClinic_Click(object sender,EventArgs e) {
			...
			comboClinicProvRule.SelectedClinicNum=FormC.ClinicNumSelected;
			FillListboxWebSchedProviderRule();
		}
		...
		private void butWebSchedPickClinic_Click(object sender,EventArgs e) {
			...
			comboWebSchedClinic.SelectedIndex=_listClinicsWebSched.FindIndex(x => x.ClinicNum==FormC.ClinicNumSelected)+1;//+1 for 'Unassigned'
			_webSchedClinicNum=FormC.ClinicNumSelected;
		}
