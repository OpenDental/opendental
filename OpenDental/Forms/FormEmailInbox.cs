	...
	public partial class FormEmailInbox:FormODBase {
		...
		private void FillComboEmail() {
			...
			if(emailAddressMe!=null) {
				comboEmailAddress.Items.Add("Me <"+emailAddressMe.EmailUsername+">");
				_listEmailAddresses.Add(emailAddressMe);//"Me"
			}
			//Add the practice default.
			if(emailAddressPractice!=null) {
				comboEmailAddress.Items.Add("Default <"+emailAddressPractice.EmailUsername+">");
				_listEmailAddresses.Add(emailAddressPractice);//Practice Default
			}
		...
		private void FillGridInbox() {
			...
			gridInbox.Columns.Add(new UI.GridColumn(Lan.g(this,"From"),colFromPixCount,HorizontalAlignment.Left));//0
			...
			gridInbox.Columns[gridInbox.Columns.Count-1].SortingStrategy=UI.GridSortingStrategy.StringCompare;
			gridInbox.Columns.Add(new UI.GridColumn(Lan.g(this,"Date Received"),colReceivedDatePixCount,HorizontalAlignment.Left));//2
			gridInbox.Columns[gridInbox.Columns.Count-1].SortingStrategy=UI.GridSortingStrategy.DateParse;
			gridInbox.Columns.Add(new UI.GridColumn(Lan.g(this,"MessageType"),colMessageTypePixCount,HorizontalAlignment.Left));//3
			gridInbox.Columns[gridInbox.Columns.Count-1].SortingStrategy=UI.GridSortingStrategy.StringCompare;
			gridInbox.Columns.Add(new UI.GridColumn(Lan.g(this,"Sig"),colSigPixCount,HorizontalAlignment.Center));//4
			gridInbox.Columns[gridInbox.Columns.Count-1].SortingStrategy=UI.GridSortingStrategy.StringCompare;
			gridInbox.Columns.Add(new UI.GridColumn(Lan.g(this,"Patient"),colPatientPixCount,HorizontalAlignment.Left));//5
			gridInbox.Columns[gridInbox.Columns.Count-1].SortingStrategy=UI.GridSortingStrategy.StringCompare;
		...
		private void activeSplitContainer_SplitterMoved(object sender,EventArgs e) {
			...
			if(activeSplitContainer.Focused) {
				//We only want to resize when the user has moved the split container.
				Console.WriteLine($"{activeSplitContainer.Name} {activeSplitContainer.Focused}");
