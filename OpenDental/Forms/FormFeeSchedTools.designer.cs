...
namespace OpenDental {
	public partial class FormFeeSchedTools {
		...
		private void InitializeComponent()
		{
			...
			this.groupGlobalUpdateFees = new OpenDental.UI.GroupBoxOD();
			...
			this.comboProviderTo = new OpenDental.UI.ComboBoxOD();
			this.comboFeeSchedTo = new OpenDental.UI.ComboBoxOD();
    ...
    "and discount plan amounts.";
		...
		private OpenDental.UI.ComboBoxOD comboFeeSchedTo;
		...
		private OpenDental.UI.GroupBoxOD groupGlobalUpdateFees;
		...
		private OpenDental.UI.ComboBoxOD comboFeeSched;
		...
		private OpenDental.UI.ComboBoxOD comboProviderTo;
