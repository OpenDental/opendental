namespace OpenDental {
    ...
    "cated.\r\nIf running on a single computer only, Server Name may be localhost.";
			...
			this.dateTimeArchive.Location = new System.Drawing.Point(150, 152);
			...
			this.textSupplementalBackupCopyNetworkPath.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.ReadOnly;
			...
			this.textSupplementalBackupDateLastComplete.QuickPasteType = OpenDentBusiness.EnumQuickPasteType.ReadOnly;
