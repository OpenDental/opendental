...
namespace OpenDental {
	public partial class FormScreenGroupEdit {
		...
		private void InitializeComponent()
		{
			...
			this.comboCounty = new OpenDental.UI.ComboBoxOD();
			this.comboGradeSchool = new OpenDental.UI.ComboBoxOD();
			...
			this.comboSheetDefs = new OpenDental.UI.ComboBoxOD();
		...
		private OpenDental.UI.ComboBoxOD comboCounty;
		...
		private OpenDental.UI.ComboBoxOD comboGradeSchool;
		...
		private OpenDental.UI.ComboBoxOD comboSheetDefs;
