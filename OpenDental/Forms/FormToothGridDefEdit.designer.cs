...
namespace OpenDental {
	public partial class FormToothGridDefEdit {
		...
		private void InitializeComponent()
		{
			...
			this.listCellType = new OpenDental.UI.ListBox();
			this.listProcStatus = new OpenDental.UI.ListBox();
			this.SuspendLayout();
			// 
			// label1
			// 
		...
		private OpenDental.UI.ListBox listCellType;
		private OpenDental.UI.ListBox listProcStatus;
	}
}
