namespace OpenDental {
	public partial class FormPayment {
		...
		private OpenDental.UI.GroupBoxOD groupXWeb;
		...
		private OpenDental.UI.ComboBoxOD comboGroupBy;
		...
		private OpenDental.UI.GroupBoxOD groupBoxFiltering;
		...
		private void InitializeComponent() {
			...
			this.groupXWeb = new OpenDental.UI.GroupBoxOD();
			...
			this.comboGroupBy = new OpenDental.UI.ComboBoxOD();
			this.label7 = new System.Windows.Forms.Label();
			this.groupBoxFiltering = new OpenDental.UI.GroupBoxOD();
			...
			this.tabProcCharges.Location = new System.Drawing.Point(498, 82);
