namespace OpenDental {
	public partial class FormPayment {
		...
		private UI.ComboBox comboClinicFilter;
		private System.Windows.Forms.Label labelPatFilter;
		private UI.ComboBox comboPatientFilter;
		...
		private UI.ComboBox comboTypeFilter;
		private OpenDental.UI.GroupBox groupBoxFiltering;
		private System.Windows.Forms.Label labelDateFrom;
		private System.Windows.Forms.DateTimePicker datePickTo;
		private System.Windows.Forms.DateTimePicker datePickFrom;
		private UI.ComboBox comboProviderFilter;
		...
		private void InitializeComponent() {
			...
			this.groupBoxFiltering = new OpenDental.UI.GroupBox();
			this.comboProviderFilter = new OpenDental.UI.ComboBox();
			...
			this.comboPatientFilter = new OpenDental.UI.ComboBox();
			this.labelProcCodes = new System.Windows.Forms.Label();
			this.comboTypeFilter = new OpenDental.UI.ComboBox();
			this.comboClinicFilter = new OpenDental.UI.ComboBox();
    ...
    "";
			...
			this.groupBoxFiltering.Location = new System.Drawing.Point(498, 2);
