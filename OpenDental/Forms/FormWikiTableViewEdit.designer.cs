namespace OpenDental{
	partial class FormWikiTableViewEdit {
		...
		private void InitializeComponent() {
			...
			this.listAvail = new OpenDental.UI.ListBox();
			this.listShowing = new OpenDental.UI.ListBox();
		...
		private OpenDental.UI.ListBox listAvail;
		private UI.Button butRight;
		private UI.Button butLeft;
		private OpenDental.UI.ListBox listShowing;
