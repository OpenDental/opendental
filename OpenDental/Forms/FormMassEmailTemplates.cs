	...
	public partial class FormMassEmailTemplates:FormODBase {
		...
		private void FillGrid() {
			...
			_listEmailHostingTemplates=EmailHostingTemplates.Refresh().FindAll(x => x.TemplateType==PromotionType.Manual
				&& x.ClinicNum==comboClinicPatient.SelectedClinicNum);
		...
		private void butNewTemplate_Click(object sender,EventArgs e) {
			...
			emailHostingTemplate.ClinicNum=comboClinicPatient.SelectedClinicNum;
		...
		private void UpdateClinicIsSignedUp() {
			...
			bool isClinicSignedUp=Clinics.IsMassEmailSignedUp(comboClinicPatient.SelectedClinicNum);
		...
		private void butCopy_Click(object sender,EventArgs e) {
			...
			copyTemplate.ClinicNum=comboClinicPatient.SelectedClinicNum;
