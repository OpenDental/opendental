namespace OpenDental {
	partial class FormCareCreditSetup {
		...
		private void InitializeComponent() {
			...
			this.groupQSBatch = new OpenDental.UI.GroupBoxOD();
			...
			this.groupPromotions = new OpenDental.UI.GroupBoxOD();
    ...
    " the manual for more information.";
		...
		private OpenDental.UI.GroupBoxOD groupPromotions;
		private UI.Button butPromotions;
		private OpenDental.UI.GroupBoxOD groupQSBatch;
