namespace OpenDental{
	partial class FormEServicesWebSchedNotify {
		...
		private void InitializeComponent() {
			...
			this.groupBoxTextTemplate = new OpenDental.UI.GroupBoxOD();
			this.textMessageTemplate = new System.Windows.Forms.TextBox();
			this.groupBoxRecallEmail = new OpenDental.UI.GroupBoxOD();
			...
			this.groupBoxRadio = new OpenDental.UI.GroupBoxOD();
		...
		private OpenDental.UI.GroupBoxOD groupBoxTextTemplate;
		private System.Windows.Forms.TextBox textMessageTemplate;
		private OpenDental.UI.GroupBoxOD groupBoxRecallEmail;
		...
		private OpenDental.UI.GroupBoxOD groupBoxRadio;
