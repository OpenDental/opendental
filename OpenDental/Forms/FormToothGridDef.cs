...
namespace OpenDental{
	...
	public partial class FormToothGridDef:FormODBase {
		...
		private List<string> listAvailableFields;
		...
		private void FillAvailList() {
			listAvailableFields = new List<string>();
			listAvailableFields.Add("Tooth");
			listAvailableFields.Add("IsPrimary");
			listAvailableFields.Add("IsMissing");
		}

		private void FillListAvailable() {
			listAvailable.Items.AddList(listAvailableFields,x => x.ToString());
		}
