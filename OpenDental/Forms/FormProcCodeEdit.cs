...
///<summary></summary>
	public partial class FormProcCodeEdit : FormODBase {
		...
		private void butNoBillInsByInsPlan_Click(object sender,EventArgs e) {
			using FormInsPlansOverrides formInsPlanOverride=new FormInsPlansOverrides(_procCodeOld.CodeNum);
			formInsPlanOverride.ShowDialog();//No UI in this proc code edit window needs to be refreshed based on the results of this window.
		}
