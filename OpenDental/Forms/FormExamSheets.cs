...
namespace OpenDental {
	public partial class FormExamSheets:FormODBase {
		...
		private void FillGrid() {
			...
			gridMain.Columns.Add(col);
			col=new GridColumn(Lan.g(this,"Type"),75){ IsWidthDynamic=true };
			gridMain.Columns.Add(col);
			...
			_listSheets=Sheets.GetExamSheetsTable(PatNum,DateTime.MinValue,DateTime.MaxValue,sheetDefSelected.SheetDefNum);//-1 when 'All' is selected
