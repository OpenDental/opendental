namespace OpenDental {
	partial class FormClaimEdit {
		...
		private void InitializeComponent() {
			...
			this.groupFinalizePayment = new OpenDental.UI.GroupBoxOD();
			...
			this.groupAccident = new OpenDental.UI.GroupBoxOD();
			this.comboAccident = new OpenDental.UI.ComboBoxOD();
			...
			this.groupReferral = new OpenDental.UI.GroupBoxOD();
			...
			this.groupProsth = new OpenDental.UI.GroupBoxOD();
			...
			this.comboEmployRelated = new OpenDental.UI.ComboBoxOD();
			this.groupOrtho = new OpenDental.UI.GroupBoxOD();
			...
			this.groupAttachments = new OpenDental.UI.GroupBoxOD();
			...
			this.groupAttachedImages = new OpenDental.UI.GroupBoxOD();
			...
			this.comboSpecialProgram = new OpenDental.UI.ComboBoxOD();
			this.labelClaimIdentifier = new System.Windows.Forms.Label();
			this.comboCorrectionType = new OpenDental.UI.ComboBoxOD();
			...
			this.groupUb04 = new OpenDental.UI.GroupBoxOD();
			this.labelBillType = new System.Windows.Forms.Label();
			this.groupValueCodes = new OpenDental.UI.GroupBoxOD();
			...
			this.groupDateIllnessInjuryPreg = new OpenDental.UI.GroupBoxOD();
			...
			this.groupDateOtherCondOrTreatment = new OpenDental.UI.GroupBoxOD();
			...
			this.groupCanadaOrthoPredeterm = new OpenDental.UI.GroupBoxOD();
			...
			this.groupMandPros = new OpenDental.UI.GroupBoxOD();
			this.comboMandProsth = new System.Windows.Forms.ComboBox();
			this.label66 = new System.Windows.Forms.Label();
			this.textDateInitialLower = new OpenDental.ValidDate();
			this.label67 = new System.Windows.Forms.Label();
			this.comboMandProsthMaterial = new OpenDental.UI.ComboBoxOD();
			this.label68 = new System.Windows.Forms.Label();
			this.groupMaxPros = new OpenDental.UI.GroupBoxOD();
			this.comboMaxProsth = new OpenDental.UI.ComboBoxOD();
			this.label69 = new System.Windows.Forms.Label();
			this.textDateInitialUpper = new OpenDental.ValidDate();
			this.label70 = new System.Windows.Forms.Label();
			this.comboMaxProsthMaterial = new OpenDental.UI.ComboBoxOD();
			...
			this.comboReferralReason = new OpenDental.UI.ComboBoxOD();
			...
			this.comboMedType = new OpenDental.UI.ComboBoxOD();
			this.label86 = new System.Windows.Forms.Label();
			this.comboClaimType = new OpenDental.UI.ComboBoxOD();
			...
			this.groupEnterPayment = new OpenDental.UI.GroupBoxOD();
			...
			this.comboPatRelat2 = new OpenDental.UI.ComboBoxOD();
			this.label10 = new System.Windows.Forms.Label();
			this.textPlan2 = new System.Windows.Forms.TextBox();
			this.groupBox2 = new OpenDental.UI.GroupBoxOD();
			this.comboPatRelat = new OpenDental.UI.ComboBoxOD();
			...
			this.comboClaimStatus = new OpenDental.UI.ComboBoxOD();
    ...
    "ed in the Chart module. ";
			...
			this.gridStatusHistory.Size = new System.Drawing.Size(1111, 233);
		...
		private OpenDental.UI.GroupBoxOD groupProsth;
		...
		private OpenDental.UI.GroupBoxOD groupOrtho;
		...
		private OpenDental.UI.ComboBoxOD comboPatRelat;
		private OpenDental.UI.ComboBoxOD comboPatRelat2;
		...
		private OpenDental.UI.ComboBoxOD comboReferralReason;
		private System.Windows.Forms.TextBox textReferralProvider;
		private OpenDental.UI.ComboBoxOD comboMaxProsth;
		private OpenDental.UI.GroupBoxOD groupMandPros;
		private System.Windows.Forms.ComboBox comboMandProsth;
		private ValidDate textDateInitialLower;
		private OpenDental.UI.ComboBoxOD comboMandProsthMaterial;
		private ValidDate textCanadianAccidentDate;
		private OpenDental.UI.GroupBoxOD groupAccident;
		...
		private OpenDental.UI.GroupBoxOD groupValueCodes;
		...
		private OpenDental.UI.ComboBoxOD comboAccident;
		private System.Windows.Forms.Label labelAccidentST;
		private OpenDental.UI.ComboBoxOD comboEmployRelated;
		...
		private OpenDental.UI.GroupBoxOD groupMaxPros;
		private ValidDate textDateInitialUpper;
		private OpenDental.UI.ComboBoxOD comboMaxProsthMaterial;
		private OpenDental.UI.GroupBoxOD groupCanadaOrthoPredeterm;
		...
		private OpenDental.UI.ComboBoxOD comboClaimType;
		private System.Windows.Forms.TextBox textPriorAuth;
		private System.Windows.Forms.Label labelPriorAuth;
		private OpenDental.UI.ComboBoxOD comboSpecialProgram;
		...
		private OpenDental.UI.ComboBoxOD comboMedType;
		private OpenDental.UI.ComboBoxOD comboClaimForm;
		...
		private OpenDental.UI.ComboBoxOD comboCorrectionType;
		private OpenDental.UI.GroupBoxOD groupAttachments;
		...
		private OpenDental.UI.GroupBoxOD groupEnterPayment;
		private OpenDental.UI.GroupBoxOD groupReferral;
		private OpenDental.UI.GroupBoxOD groupUb04;
		private OpenDental.UI.GroupBoxOD groupAttachedImages;
		...
		private OpenDental.UI.GroupBoxOD groupFinalizePayment;
		...
		private OpenDental.UI.GroupBoxOD groupDateOtherCondOrTreatment;
		...
		private OpenDental.UI.GroupBoxOD groupDateIllnessInjuryPreg;
		private System.Windows.Forms.CheckBox checkIsOutsideLab;
		private OpenDental.UI.ComboBoxOD comboClaimStatus;
