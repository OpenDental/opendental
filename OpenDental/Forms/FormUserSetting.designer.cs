namespace OpenDental{
	partial class FormUserSetting {
		...
		private void InitializeComponent() {
			...
			this.checkSuppressMessage = new OpenDental.UI.CheckBox();
			this.textLogOffAfterMinutes = new System.Windows.Forms.TextBox();
			this.labelAutoLogoff = new System.Windows.Forms.Label();
			this.checkToothChartUsesDiffColorByProv = new OpenDental.UI.CheckBox();
			this.SuspendLayout();
			// 
			// butOK
			// 
    ...
    " Settings)";
		...
		private OpenDental.UI.CheckBox checkSuppressMessage;
		private System.Windows.Forms.TextBox textLogOffAfterMinutes;
		private System.Windows.Forms.Label labelAutoLogoff;
		private OpenDental.UI.CheckBox checkToothChartUsesDiffColorByProv;
	}
}