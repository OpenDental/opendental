	...
	public partial class FormEtrans835ProcEdit:FormODBase {
		...
		private void pd_PrintPage(object sender,PrintPageEventArgs e) {
			...
			if(_gridPrintProgress==EraProcPrintingProgress.DocumentHeader) {//Only print the document heading on the first page.
				...
				grid.BeginUpdate();
				grid.Columns.Add(new GridColumn(Lan.g(this,"Proc Fee")+" -",40){ IsWidthDynamic=true });
				grid.Columns.Add(new GridColumn(Lan.g(this,"Patient Resp Sum")+" -",40){ IsWidthDynamic=true });
				grid.Columns.Add(new GridColumn(Lan.g(this,"Contractual Oblig. Sum")+" -",40){ IsWidthDynamic=true });
				grid.Columns.Add(new GridColumn(Lan.g(this,"Payor Reduction Sum")+" -",40){ IsWidthDynamic=true });
				grid.Columns.Add(new GridColumn(Lan.g(this,"Other Adjustment Sum")+" =",40){ IsWidthDynamic=true });
				grid.Columns.Add(new GridColumn(Lan.g(this,"Ins Paid Calc"),40){ IsWidthDynamic=true });
				//grid.ComputeColumns();
