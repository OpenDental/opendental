...
namespace OpenDental {
	...
	public partial class FormMessageReplacements:FormODBase {
		...
		public static List<ReplacementField> GetReplacementFieldList(bool isAllowPhi,MessageReplaceType replaceTypes,MessageReplacementSystemType messageReplacementSystemType=MessageReplacementSystemType.None) {
			...
			listReplacementGridTags.Add(new ReplacementField("[APR]","Annual Percentage Rate.",MessageReplaceType.PaymentPlan,isAllowPhi,replaceTypes));
			listReplacementGridTags.Add(new ReplacementField("[PaymentAmt]","The ammount of each payment plan charge.",MessageReplaceType.PaymentPlan,isAllowPhi,replaceTypes));
			listReplacementGridTags.Add(new ReplacementField("[ChargeFrequency]","The frequency of charges being issued.",MessageReplaceType.PaymentPlan,isAllowPhi,replaceTypes));
			listReplacementGridTags.Add(new ReplacementField("[NumOfPayments]","The total number of payments (for dynamic payment plans, always 0).",MessageReplaceType.PaymentPlan,isAllowPhi,replaceTypes));
			#endregion
