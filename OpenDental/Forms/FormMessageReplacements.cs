...
namespace OpenDental {
	...
	public partial class FormMessageReplacements:FormODBase {
		...
		private void FillGrid() {
			...
			foreach(ReplacementField tag in GetReplacementFieldList(_allowPHI,_replaceTypes,IsMassEmail)) {
				AddReplacementRow(tag);
			}
			gridMain.EndUpdate();
		}

		public static List<ReplacementField> GetReplacementFieldList(bool isAllowPhi,MessageReplaceType replaceTypes, bool isMassEmail=false) {
