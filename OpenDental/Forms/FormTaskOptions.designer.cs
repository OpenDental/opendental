namespace OpenDental{
	partial class FormTaskOptions {
		...
		private void InitializeComponent() {
			...
			this.checkBlockedTaskPlaySound = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.checkBlockedTaskPlaySound.UseVisualStyleBackColor = true;
			// 
			// FormTaskOptions
			// 
		...
		private System.Windows.Forms.CheckBox checkBlockedTaskPlaySound;
	}
}