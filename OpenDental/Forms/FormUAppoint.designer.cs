...
namespace OpenDental {
	public partial class FormUAppoint {
		...
		private void InitializeComponent()
		{
			...
			this.butSave.Location = new System.Drawing.Point(574, 419);
			...
			this.label6.Text = "Name of workstation used to sync";
			...
			this.label7.Text = "Sync interval in seconds";
			...
			this.label11.Text = "DateTime may be manually backdated to trigger resending of old sync data.";
			// 
