...
namespace OpenDental {
	public class WebFormL {
		...
		public static bool TryRetrieveAndSaveData(string cultureName,List<long> listClinicNums,int countPerBatch,out List<string> listMsgsCEMT,out List<string> listMsgsWebForms) {
