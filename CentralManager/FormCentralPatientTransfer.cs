	...
	public partial class FormCentralPatientTransfer:Form {
		...
		private void butAddDatabases_Click(object sender,EventArgs e) {
			...
			if(FormCC.ShowDialog()==DialogResult.OK) {
				...
				_listConnectionsToTransferTo.AddRange(listConnsSelected.FindAll(x=>!ListTools.In(x.CentralConnectionNum,_listConnectionsToTransferTo.Select(y => y.CentralConnectionNum))));
				FillDatabases();
			}
		}
