...
namespace UnitTests.Claims_Tests {
	...
	public class ClaimsTests:TestBase {
		...
		public void Claims_GetClaimProcGreaterThanProcFee_ProcOverpaid() {
			...
			//Test
			List<string> listResults=Claims.GetClaimProcGreaterThanProcFee(listClaimProcs);
		...
		public void Claims_GetWriteOffGreaterThanProcFee_ProcOverpaid() {
			...
			//Test
			List<string> listResults=Claims.GetWriteOffGreaterThanProcFee(listClaimProcs);
			Assert.IsTrue(listResults.Count==1);
        }
