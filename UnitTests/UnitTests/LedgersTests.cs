	...
	public class LedgersTests:TestBase {
		...
		public void LedgersTests_ComputeAgingProcLifo_LargeDb() {
			...
			foreach(Patient pat in listPats) {
				Procedure proc=ProcedureT.CreateProcedure(pat,"D8090",ProcStat.C,"",4000,DateTime.Today.AddMonths(-6).AddDays(-1),doInsert:false);
				listProcs.Add(proc);
				listPayPlans.Add(PayPlanT.CreatePayPlan(pat.PatNum,4000,166.67,DateTime.Today.AddMonths(-6).AddDays(-1),proc.ProvNum,doInsert:false,
					listPayPlanCharges));
			}
			...
			for(int i=0;i<countPats;i++) {
				...
				listAdjustments.Add(AdjustmentT.MakeAdjustment(pat.PatNum,-2800,DateTime.Today.AddMonths(-6).AddDays(-1),proc.ProcDate,proc.ProcNum,
					provNum:proc.ProvNum,adjType:defNeg.DefNum,doInsert:false));
				listPayments.Add(PaymentT.MakePayment(pat.PatNum,166.67,DateTime.Today.AddMonths(-6).AddDays(-1),payPlanNum:payPlan.PayPlanNum,
					provNum:proc.ProvNum,procNum:proc.ProcNum,payType:defPay.DefNum,doInsert:false,listSplits:listSplits));
				listPayPlanCharges.Add(PayPlanChargeT.CreateOne(payPlan.PayPlanNum,pat.Guarantor,pat.PatNum,DateTime.Today.AddMonths(-6).AddDays(-1),
					1200,0,"D8090:  CompOrthoAdlt",proc.ProvNum,0,PayPlanChargeType.Credit,proc.ProcNum,doInsert:false));
				listAdjustments.Add(AdjustmentT.MakeAdjustment(pat.PatNum,121.74,DateTime.Today.AddMonths(-5).AddDays(-1),proc.ProcDate,proc.ProcNum,
					provNum:proc.ProvNum,adjType:defPos.DefNum,doInsert:false));
				listPayments.Add(PaymentT.MakePayment(pat.PatNum,166.67,DateTime.Today.AddMonths(-5).AddDays(-1),payPlanNum:payPlan.PayPlanNum,
					provNum:proc.ProvNum,procNum:proc.ProcNum,payType:defPay.DefNum,doInsert:false,listSplits:listSplits));
				listPayPlanCharges.Add(PayPlanChargeT.CreateOne(payPlan.PayPlanNum,pat.Guarantor,pat.PatNum,DateTime.Today.AddMonths(-5).AddDays(-1),
					121.74,0,"D8090:  CompOrthoAdlt",proc.ProvNum,0,PayPlanChargeType.Credit,proc.ProcNum,doInsert:false));
				listAdjustments.Add(AdjustmentT.MakeAdjustment(pat.PatNum,121.74,DateTime.Today.AddMonths(-4).AddDays(-1),proc.ProcDate,proc.ProcNum,
					provNum:proc.ProvNum,adjType:defPos.DefNum,doInsert:false));
				listPayPlanCharges.Add(PayPlanChargeT.CreateOne(payPlan.PayPlanNum,pat.Guarantor,pat.PatNum,DateTime.Today.AddMonths(-4).AddDays(-1),
					121.74,0,"D8090:  CompOrthoAdlt",proc.ProvNum,0,PayPlanChargeType.Credit,proc.ProcNum,doInsert:false));
				listAdjustments.Add(AdjustmentT.MakeAdjustment(pat.PatNum,121.74,DateTime.Today.AddMonths(-3).AddDays(-1),proc.ProcDate,proc.ProcNum,
					provNum:proc.ProvNum,adjType:defPos.DefNum,doInsert:false));
				listPayPlanCharges.Add(PayPlanChargeT.CreateOne(payPlan.PayPlanNum,pat.Guarantor,pat.PatNum,DateTime.Today.AddMonths(-3).AddDays(-1),
					121.74,0,"D8090:  CompOrthoAdlt",proc.ProvNum,0,PayPlanChargeType.Credit,proc.ProcNum,doInsert:false));
				listAdjustments.Add(AdjustmentT.MakeAdjustment(pat.PatNum,121.74,DateTime.Today.AddMonths(-2).AddDays(-1),proc.ProcDate,proc.ProcNum,
					provNum:proc.ProvNum,adjType:defPos.DefNum,doInsert:false));
				listPayPlanCharges.Add(PayPlanChargeT.CreateOne(payPlan.PayPlanNum,pat.Guarantor,pat.PatNum,DateTime.Today.AddMonths(-2).AddDays(-1),
					121.74,0,"D8090:  CompOrthoAdlt",proc.ProvNum,0,PayPlanChargeType.Credit,proc.ProcNum,doInsert:false));
				listAdjustments.Add(AdjustmentT.MakeAdjustment(pat.PatNum,121.74,DateTime.Today.AddMonths(-1).AddDays(-1),proc.ProcDate,proc.ProcNum,
					provNum:proc.ProvNum,adjType:defPos.DefNum,doInsert:false));
				listPayPlanCharges.Add(PayPlanChargeT.CreateOne(payPlan.PayPlanNum,pat.Guarantor,pat.PatNum,DateTime.Today.AddMonths(-1).AddDays(-1),
					121.74,0,"D8090:  CompOrthoAdlt",proc.ProvNum,0,PayPlanChargeType.Credit,proc.ProcNum,doInsert:false));
			}
