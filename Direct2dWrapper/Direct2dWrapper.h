...
class Direct2DWrapper{
	...
	private:
		Microsoft::WRL::ComPtr<ID2D1Factory1> m_ID2D1Factory1;
		Microsoft::WRL::ComPtr<ID2D1BitmapRenderTarget> m_ID2D1BitmapRenderTarget;
		Microsoft::WRL::ComPtr<ID2D1DCRenderTarget> m_ID2D1DCRenderTarget;
		UINT32 m_width;
		UINT32 m_height;
		HDC m_hdc;
		//device independent:
		Microsoft::WRL::ComPtr<ID2D1DrawingStateBlock> m_ID2D1DrawingStateBlock;
