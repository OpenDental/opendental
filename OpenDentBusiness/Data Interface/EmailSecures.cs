...
namespace OpenDentBusiness{
	...
	public class EmailSecures {
		...
		public static void InsertMessageThenSend(EmailMessage message,EmailAddress senderAddress,string toAddress,
			long clinicNum,EmailMessage messageReplyingTo=null,Patient pat=null) 
		{
			...
			SendSecureEmail(message,senderAddress,toAddress,clinicNum,messageReplyingTo,pat);
		}
