	...
	public class EClipboardSheetDefs{
		...
		*/
		...
		public static List<EClipboardSheetDef> FilterPrefillStatuses(List<EClipboardSheetDef> listeClipSheetDefs,List<Sheet> listSheetsCompleted) {
			...
			//Remove any sheet defs that are set to PrefillStatuses.Once and have been filled out.
			retVal.RemoveAll(x=>x.PrefillStatus==PrefillStatuses.Once && listSheetsCompleted.Any(y=>y.SheetDefNum==x.SheetDefNum));
