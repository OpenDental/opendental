...
namespace OpenDentBusiness{
	...
	public class LanguageForeigns {
		...
		public static LanguageForeign GetForCulture(List<LanguageForeign> listForType,string english,string cultureName){
			//No need to check MiddleTierRole; no call to db.
			for(int i=0;i<listForType.Count;i++){
		...
		public static LanguageForeign GetOther(List<LanguageForeign> listForType,string english,string cultureName){
			//No need to check MiddleTierRole; no call to db.
			for(int i=0;i<listForType.Count;i++){
				if(english!=listForType[i].English){
					continue;
