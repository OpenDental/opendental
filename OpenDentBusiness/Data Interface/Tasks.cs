		...
		{			
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetTable(MethodBase.GetCurrentMethod(),userNum,listTaskListNums,listTaskNums,taskDateCreatedFrom,taskDateCreatedTo,
					taskDateCompletedFrom,taskDateCompletedTo,taskDescription,taskPriorityNum,patNum,doIncludeTaskNote,doIncludeCompleted,doIncludeAttachments,
			...
			List<long> listSearchTaskNums=ReportsComplex.RunFuncOnReportServer(() => GetTasksNumsForSearch(userNum,listTaskListNums,listTaskNums,dateCreatedFrom,
					dateCreatedTo,dateCompletedFrom,dateCompletedTo,taskDescription,taskPriorityNum,patNum,doIncludeTaskNote,doIncludeCompleted,doIncludeAttachments,limit),
				doRunOnReportServer);			
			...
			bool doIncludeTaskNote,bool doIncludeCompleted,bool doIncludeAttachments,bool limit) 
		{
			if(RemotingClient.MiddleTierRole==MiddleTierRole.ClientMT) {
				return Meth.GetObject<List<long>>(MethodBase.GetCurrentMethod(),userNum,listTaskListNums,listTaskNums,dateCreatedFrom,dateCreatedTo,
					dateCompletedFrom,dateCompletedTo,taskDescription,taskPriorityNum,patNum,doIncludeTaskNote,doIncludeCompleted,doIncludeAttachments,limit);
			}
