	...
	public class RepeatCharges {
		...
		public static RepeatChargeResult RunRepeatingCharges(DateTime dateRun,bool doComputeAging=true) {
			...
			try {
				...
				List<OrthoCaseProcedureLinker> listOrthoCaseProcedureLinkers=OrthoCaseProcedureLinker.CreateManyForPatients(listRepeatingCharges.Select(x => x.PatNum).ToList());
