	...
	public class InsPlans {
		...
		public static bool AreEqualValue(InsPlan plan1,InsPlan plan2) {
			if(plan1.PlanNum==plan2.PlanNum
				...
				&& plan1.PerVisitPatAmount==plan2.PerVisitPatAmount
				&& plan1.PerVisitInsAmount==plan2.PerVisitInsAmount)
		...
		public static bool UsesUcrFeeForExclusions(ExclusionRule exclusionRule) {
			return exclusionRule==ExclusionRule.UseUcrFee 
				|| (exclusionRule==ExclusionRule.PracticeDefault && PrefC.GetBool(PrefName.InsPlanUseUcrFeeForExclusions));
		}
