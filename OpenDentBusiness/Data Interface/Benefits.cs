...
namespace OpenDentBusiness {
	...
	public class Benefits {
		...
		/// <summary>Returns true if the given benefit represents an ortho age benefit.</summary>
		...
		/// <summary>Returns true if the given benefit represents a coinsurance benefit.</summary>
		...
		/// <summary>Returns true if the given benefit represents a waiting period benefit.</summary>
