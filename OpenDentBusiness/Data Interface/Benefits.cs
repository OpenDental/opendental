...
namespace OpenDentBusiness {
	...
	public class Benefits {
		...
		public static double GetLimitationByCode(List<Benefit> benList,long planNum,long patPlanNum,DateTime procDate,
			...
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenFlourideCodes).Contains(ProcedureCodes.GetCodeNum(procCodeStr))) {
			...
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenSealantCodes).Contains(ProcedureCodes.GetCodeNum(procCodeStr))) {
		...
		public static bool IsFlourideAgeLimit(Benefit ben) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenFlourideCodes).Contains(ben.CodeNum)
		...
		public static bool IsSealantAgeLimit(Benefit ben) {
			if(ben.CodeNum==ProcedureCodes.GetCodeNumForPref(PrefName.InsBenSealantCodes)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.MonetaryAmt==-1
				&& ben.PatPlanNum==0
				&& ben.Percent==-1
		...
		public static bool IsBitewingFrequency(Benefit ben,long patPlanNum=0) {
			//List<long> listCodeNums=ProcedureCodes.GetListBWCodeNums();
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenBWCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				//&& ben.CovCatNum==CovCats.GetForEbenCat(EbenefitCategory.Db).CovCatNum//ignored
				&& ben.MonetaryAmt==-1
		...
		public static bool IsPanoFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenPanoCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				//&& ben.CovCatNum==CovCats.GetForEbenCat(EbenefitCategory.Db).CovCatNum//ignored
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsExamFrequency(Benefit ben,long patPlanNum=0) {
			if(ben.BenefitType==InsBenefitType.Limitations
				...
				&& ((CovCats.GetForEbenCat(EbenefitCategory.RoutinePreventive)!=null 
					...
					&& ben.CodeNum==0)  
					|| ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenExamCodes).Contains(ben.CodeNum))
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
				&& ben.Percent==-1
				&& ((ben.QuantityQualifier.In(BenefitQuantity.Months,BenefitQuantity.Years) && ben.TimePeriod==BenefitTimePeriod.None)
		...
		public static bool IsCancerScreeningFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenCancerScreeningCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsProphyFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenProphyCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsSealantFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenSealantCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsCrownFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenCrownCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsSRPFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenSRPCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsFullDebridementFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenFullDebridementCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsPerioMaintFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenPerioMaintCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsDenturesFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenDenturesCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
		...
		public static bool IsImplantFrequency(Benefit ben,long patPlanNum=0) {
			if(ProcedureCodes.GetCodeNumsForPref(PrefName.InsBenImplantCodes).Contains(ben.CodeNum)
				&& ben.BenefitType==InsBenefitType.Limitations
				&& ben.CovCatNum==0
				&& ben.MonetaryAmt==-1
				&& (ben.PatPlanNum==patPlanNum || ben.PatPlanNum==0)
