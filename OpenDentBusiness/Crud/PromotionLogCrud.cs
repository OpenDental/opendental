	...
	public class PromotionLogCrud {
		...
		public static List<PromotionLog> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				promotionLog.SendStatus         = (OpenDentBusiness.AutoCommStatus)PIn.Int(row["SendStatus"].ToString());
				promotionLog.MessageType        = (OpenDentBusiness.CommType)PIn.Int(row["MessageType"].ToString());
