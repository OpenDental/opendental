...
namespace OpenDentBusiness.Crud{
	public class PatientNoteCrud {
		...
		public static long Insert(PatientNote patientNote,bool useExistingPK) {
			...
			command+="FamFinancial,ApptPhone,Medical,Service,MedicalComp,Treatment,ICEName,ICEPhone,OrthoMonthsTreatOverride,DateOrthoPlacementOverride,SecDateTEntry,Consent,UserNumOrthoLocked) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
