...
namespace OpenDentBusiness.Crud{
	public class ApptFieldDefCrud {
		...
		public static bool Sync(List<ApptFieldDef> listNew,List<ApptFieldDef> listDB) {
			...
			listNew.Sort((ApptFieldDef x,ApptFieldDef y) => { return x.ApptFieldDefNum.CompareTo(y.ApptFieldDefNum); });//Anonymous function, sorts by compairing PK.  Lambda expressions are not allowed, this is the one and only exception.  JS approved.
			listDB.Sort((ApptFieldDef x,ApptFieldDef y) => { return x.ApptFieldDefNum.CompareTo(y.ApptFieldDefNum); });//Anonymous function, sorts by compairing PK.  Lambda expressions are not allowed, this is the one and only exception.  JS approved.
			int idxNew=0;
			int idxDB=0;
