...
namespace OpenDentBusiness.Crud{
	public class PayPlanCrud {
		...
		public static long Insert(PayPlan payPlan,bool useExistingPK) {
			...
			command+="PatNum,Guarantor,PayPlanDate,APR,Note,PlanNum,CompletedAmt,InsSubNum,PaySchedule,NumberOfPayments,PayAmt,DownPayment,IsClosed,Signature,SigIsTopaz,PlanCategory,IsDynamic,ChargeFrequency,DatePayPlanStart,IsLocked,DateInterestStart,DynamicPayPlanTPOption,MobileAppDeviceNum) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			if(!useExistingPK && PrefC.RandomKeys) {
				...
				while(index < listPayPlans.Count) {
					...
					if(sbCommands==null) {
						...
						sbCommands.Append("PatNum,Guarantor,PayPlanDate,APR,Note,PlanNum,CompletedAmt,InsSubNum,PaySchedule,NumberOfPayments,PayAmt,DownPayment,IsClosed,Signature,SigIsTopaz,PlanCategory,IsDynamic,ChargeFrequency,DatePayPlanStart,IsLocked,DateInterestStart,DynamicPayPlanTPOption,MobileAppDeviceNum) VALUES ");
						countRows=0;
					}
					else {
						hasComma=true;
