...
namespace OpenDentBusiness.Crud{
	public class PayConnectResponseWebCrud {
		...
		public static long Insert(PayConnectResponseWeb payConnectResponseWeb,bool useExistingPK) {
			...
			command+="PatNum,PayNum,CCSource,Amount,PayNote,AccountToken,PayToken,ProcessingStatus,DateTimeEntry,DateTimePending,DateTimeCompleted,DateTimeExpired,DateTimeLastError,LastResponseStr,IsTokenSaved,PaymentToken,ExpDateToken,RefNumber,TransType,EmailResponse) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
