...
namespace OpenDentBusiness.Crud{
	public class MsgToPaySentCrud {
		...
		public static long Insert(MsgToPaySent msgToPaySent,bool useExistingPK) {
			...
			command+="PatNum,ClinicNum,SendStatus,Source,MessageType,MessageFk,Subject,Message,EmailType,DateTimeEntry,DateTimeSent,ResponseDescript,ApptReminderRuleNum,ShortGUID,DateTimeSendFailed) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
