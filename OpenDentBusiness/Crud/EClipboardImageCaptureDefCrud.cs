...
namespace OpenDentBusiness.Crud{
	public class EClipboardImageCaptureDefCrud {
		...
		public static bool Sync(List<EClipboardImageCaptureDef> listNew,List<EClipboardImageCaptureDef> listDB) {
			...
			listNew.Sort((EClipboardImageCaptureDef x,EClipboardImageCaptureDef y) => { return x.EClipboardImageCaptureDefNum.CompareTo(y.EClipboardImageCaptureDefNum); });//Anonymous function, sorts by compairing PK.  Lambda expressions are not allowed, this is the one and only exception.  JS approved.
			listDB.Sort((EClipboardImageCaptureDef x,EClipboardImageCaptureDef y) => { return x.EClipboardImageCaptureDefNum.CompareTo(y.EClipboardImageCaptureDefNum); });//Anonymous function, sorts by compairing PK.  Lambda expressions are not allowed, this is the one and only exception.  JS approved.
			int idxNew=0;
			int idxDB=0;
