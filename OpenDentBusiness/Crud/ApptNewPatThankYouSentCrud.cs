...
namespace OpenDentBusiness.Crud{
	public class ApptNewPatThankYouSentCrud {
		...
		public static long Insert(ApptNewPatThankYouSent apptNewPatThankYouSent,bool useExistingPK) {
			...
			command+="ApptSecDateTEntry,DateTimeNewPatThankYouTransmit,ShortGUID,ApptNum,ApptDateTime,TSPrior,PatNum,ClinicNum,SendStatus,MessageType,MessageFk,DateTimeEntry,DateTimeSent,ResponseDescript,ApptReminderRuleNum) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			if(!useExistingPK && PrefC.RandomKeys) {
				...
				while(index < listApptNewPatThankYouSents.Count) {
					...
					if(sbCommands==null) {
						...
						sbCommands.Append("ApptSecDateTEntry,DateTimeNewPatThankYouTransmit,ShortGUID,ApptNum,ApptDateTime,TSPrior,PatNum,ClinicNum,SendStatus,MessageType,MessageFk,DateTimeEntry,DateTimeSent,ResponseDescript,ApptReminderRuleNum) VALUES ");
						countRows=0;
					}
					else {
						hasComma=true;
