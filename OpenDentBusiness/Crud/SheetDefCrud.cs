...
namespace OpenDentBusiness.Crud{
	public class SheetDefCrud {
		...
		public static long Insert(SheetDef sheetDef,bool useExistingPK) {
			...
			command+="Description,SheetType,FontSize,FontName,Width,Height,IsLandscape,PageCount,IsMultiPage,BypassGlobalLock,HasMobileLayout,DateTCreated,RevID,AutoCheckSaveImage) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
