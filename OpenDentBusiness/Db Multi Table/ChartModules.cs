	...
	public class ChartModules {
		...
		public class LoadData {
			...
			public void ClearData() {
				...
				this.ListDocuments=new List<Document>();
				this.ListMounts=new List<Mount>();
		...
		public static LoadData GetAll(long patNum,bool isAuditMode,ChartModuleComponentsToLoad componentsToLoad,bool doMakeSecLog) {
			...
			Logger.LogAction("Documents.GetAllForPat",LogPath.ChartModule,() => data.ListDocuments=Documents.GetAllForPat(patNum));
			Logger.LogAction("Mounts.GetAllWithPat",LogPath.ChartModule,() => data.ListMounts=Mounts.GetForChart(patNum));
