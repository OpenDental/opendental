...
namespace OpenDentBusiness.Bridges{
	...
	public class Pearl{
		/*
			//S47726-Pearl bridge
			//The Pearl conversion has stalled, so I've moved this here to archive until we start again.
			//This is not ready to use yet, but for testing Pearl, you can uncomment.
			...
			command="INSERT INTO programproperty (ProgramNum,PropertyDesc,PropertyValue" 
				 ...
				 +"'OfficeID?', " //todo: I think we actually need about 3 or 4 properties.
				 +"'')"; 
			Db.NonQ(command); 
			command="INSERT INTO programproperty (ProgramNum,PropertyDesc,PropertyValue" 
				 +") VALUES(" 
