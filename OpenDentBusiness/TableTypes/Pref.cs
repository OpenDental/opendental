...
//jordan The prefs below that start with "default" are badly named. Always start with most significant word, not least. Default should be suffix.
		...
		///<summary>Boolean. 1 by default. When enabled, addresses entered in formPatientEdit and addresses on patient forms imported using sheet import will be verified with the USPS Addresses V3 API before saving.</summary>
