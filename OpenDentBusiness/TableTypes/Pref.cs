...
namespace OpenDentBusiness {
	...
	public enum PrefName {
		...
		///<summary>FK to Definition.DefNum. Default Image Category folder for files to import into when no Image Category is selected in images module. 0 denotes no default Image Category is selected.</summary>
		[PrefName(ValueType=PrefValueType.LONG)]
		DefaultImageCategoryImportFolder,
