...
namespace OpenDentBusiness {
	///<summary>A single action attached to a ERoutingDef. There are usually many.  Changing these does not alter any patient records. Only used in eClipboard for now.</summary>
	public class ERoutingActionDef:TableBase {
		///<summary>PK</summary>
		[CrudColumn(IsPriKey=true)]
		public long ERoutingActionDefNum;
		/// <summary>FK to eroutingdef.ERoutingDefNum. Defines what erouting this action is tied to</summary>
		public long ERoutingDefNum;
		/// <summary>Enum:EnumERoutingActionType </summary>
		public EnumERoutingActionType ERoutingActionType;
		/// <summary>Determines the order the items show in the patienteroutingactiondef and what order they are to be completed in.</summary>
