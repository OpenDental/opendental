...
namespace OpenDentBusiness {
	...
	public enum DefCat {
		...
		///S = Statements, T = Graphical Tooth Charts, R = Treatment Plans, E = Expanded, A = Payment Plans, C = Claim Attachments, B = Lab Cases, U = Autosave Forms, Y = Task Attachments.</summary>
