...
namespace OpenDentBusiness {
	///<summary>AUtoComm object for MsgToPay messages that have been queued or sent by the eConnector. The HQ version of this object is MsgToPayActive where a record is kept for ShortGuid/redirect purposes.</summary>
	public class MsgToPaySent:TableBase,IAutoCommGuid {
