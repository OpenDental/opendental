...
-TabIndexOD can be set, but it doesn't seem to work yet. Not sure why. You can still tab between textboxes with a tabcontrol once you get into it.
-If you're setting the text of a tabPage in code, you use the Header property.
-The Header is an object, but just treat it like a string.
