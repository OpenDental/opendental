...
namespace WpfControls {
	public class EFormL {
		...
		///<summary>If SaveImageCategory is 0, this does nothing.</summary>
		public static void SaveToImages(EForm eForm){
			if(eForm.SaveImageCategory==0){
				return;
			}
			Patient patient=Patients.GetPat(eForm.PatNum);
