...
namespace fyiReporting.RDL
{
	...
	internal class Matrix : DataRegion
	{
		...
		int RunCountSubtotalRows(WorkClass wc, MatrixEntry m, int level)
		{
			// Get the number of static columns
			...
			if (m.SortedData == null || level+1 >= _RowGroupings.Items.Count)		   
				return count;
