	...
	internal class DataSetDefn : ReportLink
	{
		...
		internal void GetData(Report rpt)
		{
			...
			{		// Override the query and provide data from XML
				...
				_Query.GetData(rpt, xdata, _Fields, _Filters);	// get the data (and apply the filters
				return;
			}
			...
			_Query.GetData(rpt, this._Fields, _Filters);	// get the data (and apply the filters
		}
